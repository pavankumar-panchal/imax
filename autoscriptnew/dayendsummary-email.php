<?
	...
	{
		echo('here1'); exit;
		$datethismonth = "DATE_FORMAT(curdate() ,'%Y-%m-01')";
	}
	...
	echo($monthsdatepiece);exit;
	
	$managedareaarray = array(
						"BKG" => array("regionid" => '1',"area" => "BKG", "emailid" => array("paramesh.n@relyonsoft.com","nitinall@relyonsoft.com"), "name" => array("Paramesh N","Nitin S Patel")),
						"BKM" => array("regionid" => '3',"area" => "BKM", "emailid" => array("raghavendra.n@relyonsoft.com","nitinall@relyonsoft.com"), "name" => array("Raghavendra N","Nitin S Patel")),
						"CSD" => array("regionid" => '2',"area" => "CSD", "emailid" => array("pradeep.n@relyonsoft.com"),
...
/*	$managedareaarray = array(
					...
					"CSD" => array("regionid" => '2',"area" => "CSD", "emailid" => array("vijay@relyonsoft.com","pradeep.n@relyonsoft.com","vidyananda.csd@relyonsoft.com"),
	...
	if($_SERVER['HTTP_HOST'] == 'bhavesh')  
	{
		//$bccarray = array('Bhavesh' =>'bhavesh@relyonsoft.com');
	}
	else
	{
		//$bccarray = array('webmaster@relyonsoft.com','bhavesh@relyonsoft.com');
	}
	...
	$query2 = "select * from inv_invoicenumbers where ".$monthsdatepiece."  and `status` <> 'CANCELLED'";
	...
	while($fetch = mysql_fetch_array($result))
	{
		...
		{
			$emailid = 'bhavesh@relyonsoft.com';
		}
		else
		{
...
left join(select servicename,ifnull(sum(serviceamount),'0') as netamount from services where ".$servicedatethismonth." group by servicename)as thismonth on thismonth.servicename = inv_mas_service.servicename group by inv_mas_service.servicename order by inv_mas_service.servicename ";
	...
	if($_SERVER['HTTP_HOST'] == '192.168.2.132')  
	{
		//$emailid = array('bhavesh@relyonsoft.com');
	}
	else
	{
