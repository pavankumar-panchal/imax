                                                      ...
                                                      <tr>
                                                        <td bgcolor="#f7faff"><fieldset style="border:1px solid #666666; padding:3px;">
                                                          ...
                                                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                            ...
                                                            <tr >
                                                              <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="3" style="padding-left:7px">
  <tr>
                                      ...
                                      <td align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <td width="31%" align="right" valign="middle"><input name="filter" type="button" class="swiftchoicebutton" id="filter" value="Filter" onclick="searchfilter('');" />
                                              &nbsp;&nbsp;
                                              <input name="clear" type="button" class="swiftchoicebutton-red" id="clear" value="Clear" onclick="clearsearchform()" /></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                    <tr>
                                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                                          ...
                                          <tr>
                                            <td style="padding:0"><div id="displaysearchresult" style="overflow:auto; height:150px; width:928px; padding:2px;" align="center">
