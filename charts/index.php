                                                ...
                                                <tr bgcolor="#EDF4FF">
                                                  <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                      <tr>
                                                        ...
                                                        <td width="70%"><select name="groupwise"
                                                            class="swiftselect-mandatory" id="groupwise"
                                                            style=" width:225px">
                                                      ...
                                                      <tr>
                                                        <td>Dealer:</td>
                                                        <td><select name="dealerwise" class="swiftselect-mandatory"
                                                            id="dealerwise" style=" width:225px">
                                                            <option value="">ALL</option>
                                                      ...
                                                      <tr>
                                                        <td>State:</td>
                                                        <td><select name="statewise" class="swiftselect-mandatory"
                                                            id="statewise" style=" width:225px">
                                                            <option value="">ALL</option>
                                                  ...
                                                  <td width="50%" valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                      <tr>
                                                        <td>Branch:</td>
                                                        <td><select name="branchwise" class="swiftselect-mandatory"
                                                            id="branchwise" style=" width:225px">
                                                            <option value="">ALL</option>
                                                      ...
                                                      <tr>
                                                        <td>Type:</td>
                                                        <td><select name="typewise" class="swiftselect-mandatory"
                                                            id="typewise" style=" width:225px">
                                                            <option value="">ALL</option>
                                                      ...
                                                      <tr>
                                                        <td>Category:</td>
                                                        <td><select name="categorywise" class="swiftselect-mandatory"
                                                            id="categorywise" style=" width:225px">
                                                            <option value="">ALL</option>
                                                      ...
                                                      <tr>
                                                        <td colspan="2">
                                                          <fieldset style="border:1px solid #666666; padding:3px;">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                              ...
                                                              <tr>
                                                                <td align="left">
                                                                  <label for="splityear">
                                                                    <input type="checkbox" name="splityear"
                                                                      id="splityear" value="splityear"
                                                                      checked="checked" />
                                                                    Year Wise</label>
                                                                </td>
                                                              </tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                  <tr>
                                                    ...
                                                    <td width="13%"><label for="databasefield0">
                                                        <input type="radio" name="charts" id="databasefield0"
                                                          value="dealer" />
                                                        Dealer wise</label></td>
                                                    <td width="13%"><label for="databasefield1">
                                                        <input type="radio" name="charts" id="databasefield1"
                                                          value="branch" checked="checked" />
                                                        Branch wise</label></td>
                                                    <td width="13%"><label for="databasefield2">
                                                        <input type="radio" name="charts" id="databasefield2"
                                                          value="state" />
                                                        State wise</label></td>
                                                    <td width="12%"><label for="databasefield3">
                                                        <input type="radio" name="charts" value="customertype"
                                                          id="databasefield3" />
                                                        Type wise</label></td>
                                                    <td width="45%"><label for="databasefield4">
                                                        <input type="radio" name="charts" value="customercategory"
                                                          id="databasefield4" />
                                    ...
                                    <tr>
                                      <td align="right" valign="middle"
                                        ...
                                        <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="57%" align="left" valign="middle" height="35" id="form-error">
                                              &nbsp;</td>
                                            <td width="43%" align="right" valign="middle">&nbsp;
                                              <input name="view" type="submit" class="swiftchoicebutton" id="view"
                                                value="View" onClick="formsubmit();" />
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
