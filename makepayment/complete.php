...
if($ResponseCode == 0) //Success
{
	...
	$username = $fetchresult['createdby'];
			
	//Insert Receipt Details 
	$query = "INSERT INTO inv_mas_receipt(invoiceno,receiptamount,paymentmode,receiptremarks,privatenote,createddate,createdby,createdip,lastmodifieddate,lastmodifiedby,lastmodifiedip,customerreference,receiptdate,receipttime,module,partialpayment) values('".$onlineinvoiceslno."','".$balanceamount."','creditordebit','','','".datetimelocal('Y-m-d').' '.datetimelocal('H:i:s')."','".$createdby."','".$_SERVER['REMOTE_ADDR']."','".datetimelocal('Y-m-d').' '.datetimelocal('H:i:s')."','".$createdby."','".$_SERVER['REMOTE_ADDR']."','".$custreference."','".datetimelocal('Y-m-d')."','".datetimelocal('H:i:s')."','user_module','no');";
	...
	array('../images/relyon-rupee-small.jpg','inline','1234567999')
	);
	...
	$subject = "Payment made successfully by ".$company." (".$username.")";
	$html = $msg;
	$text = $textmsg;
                                                              ...
                                                              <tr>
                                                                <td  valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3" style="border:solid 2px #272727">
                                                                    <td ><table width="100%" border="0" cellspacing="0" cellpadding="5"  >
                                                                          ...
                                                                          <tr>
                                                                            <td colspan="2" class="fontstyle" ><p align="left">You have been successfully paid for <img src="../images/relyon-rupee-small.jpg" width="8" height="10" /><font color="#000000">&nbsp;<? echo($amount.'.00')?></font>. An email also have been sent to <font color="#FF0000"><? echo($emailid)?></font> with the confirmation.<br />
                                                                            </p></td>
                                                                          </tr>
                                                                          <tr>
