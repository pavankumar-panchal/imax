...
<script language="javascript" src="../functions/invoicedetails.js?dummy=<? echo (rand());?>"></script>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            <td width="27%" class="active-leftnav">Invoice Details</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="3" height="100">
                                              <tr>
                                                <td valign="top" align="left"><label for="geography1">
                                                  ...
                                                  <input name="geography" type="radio" id="geography0" value="region" onclick="enablegeography();" disabled="disabled" />
                                                  Region </label>
                                                    ...
                                                    <tr>
                                                      <td align="left"><label for="groupon0">
                                                        ...
                                                        Product </label>
                                                          ...
                                                          <label for="groupon1">
                                                          <input type="radio" name="groupon" id="groupon1" value="generatedby" disabled="disabled" />
                                                            Generated By </label>
  ...
  <tr>
    <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr bgcolor="#f7faff">
        ...
        <td valign="top" bgcolor="#edf4ff" align="left"><select name="usagetype" class="swiftselect" id="usagetype"    style=" width:225px" disabled="disabled">
...
<tr bgcolor="#F7FAFF">
    ...
    <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td bgcolor="#EDF4FF" align="left"><select name="card" class="swiftselect" id="card"  style=" width:225px" disabled="disabled">
            <option value="" selected="selected">ALL</option>
