...
<script language="javascript" src="../functions/cuscardattachreport.js?dummy=<? echo (rand());?>"></script>
                                        ...
                                        <td colspan="2"><strong>Attached Date</strong></td>
                                         ...
                                         <tr><td colspan="2"> <fieldset style="border:1px solid #666666; padding:2px;">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                              ...
                                              <tr bgcolor="#EDF4FF">
                                                <td valign="top" align="left">Attached By:</td>
                                                <td valign="top" align="left"><select name="attachedby" class="swiftselect" id="attachedby"  style=" width:225px" >
                                                    <option value="">ALL</option>
                                                    <? include('../inc/selectusers.php'); ?>
                                                  </select>                                                </td>
                                              </tr>
                                              <tr bgcolor="#edf4ff">
