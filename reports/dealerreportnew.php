...
<script language="javascript" src="../functions/dealerreportnew.js?dummy=<? echo (rand());?>"></script>
                                      ...
                                      <tr>
                                        <td colspan="2" align="left"><strong>Attached Date</strong></td>
                                          ...
                                          <tr bgcolor="#f7faff">
                                            ...
                                            <td valign="top" bgcolor="#f7faff"  align="left"><input name="fromdate" type="text" class="swifttext-mandatory" id="DPC_attachfromdate" size="30" autocomplete="off" value="<? echo(datetimelocal('d-m-Y')); ?>" readonly="readonly"/>                                              <input type="hidden" name="flag" id="flag" value="true" />
                                            <br /></td>
                                          </tr>
                                          <tr bgcolor="#f7faff">
                                            <td valign="top" bgcolor="#EDF4FF"  align="left">To Date:</td>
                                            <td valign="top" bgcolor="#EDF4FF"  align="left"><input name="todate" type="text" class="swifttext-mandatory" id="DPC_attachtodate" size="30" autocomplete="off" value="<? echo(datetimelocal('d-m-Y')); ?>" readonly="readonly" />                                           </td>
                                          </tr>
                                          <tr bgcolor="#edf4ff">
                                         ...
                                         <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr bgcolor="#F7FAFF">
                                            ...
                                            <td valign="top" bgcolor="#EDF4FF" align="left"><select name="pintype" class="swiftselect" id="pintype" style="width:140px" onchange='disableregistration()'>
                                             ...
                                             <tr bgcolor="#F7FAFF">
                                                 <td valign="top" bgcolor="#EDF4FF" align="left">Dealer Types</td>
                                                 <td valign="top" bgcolor="#EDF4FF" align="left"><select name="dealertype" class="swiftselect" id="dealertype" style="width:140px">
                                                         <option value="" selected="selected">ALL</option>
										...
										<tr bgcolor="#f7faff">
                                            <td colspan="2" valign="top" bgcolor="#EDF4FF">
                                                <fieldset style="border:1px solid #666666; padding:2px;">
                                                ...
                                                <td valign="top"  align="left"><label for="geography1">
                                                  ...
                                                  Region </label>
                                                    ...
                                                    <label for="geography3">
                                                        <input type="radio" name="geography" id="geography3" value="branch" onclick="enablegeography();" />
                                                        Branch </label></td>
                                              </tr>
                                              <tr>
                                                ...
                                                <div id="statediv" style="display:none;">
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                    ...
                                                    <div id="branchdiv" style="display:none;">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                            <tr>
                                                                <td width="29%" align="left">Select A Branch:&nbsp;&nbsp;</td>
                                                                <td width="71%" align="left"><select name="branch" class="swiftselect-mandatory" id="branch" disabled="disabled">
