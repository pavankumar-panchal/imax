...
IFNULL(prd201516.group,'') as prd201516,IFNULL(prd201617.group,'') as prd201617,IFNULL(prd201718.group,'') as prd201718,IFNULL(prd201819.group,'') as prd201819,IFNULL(prd201920.group,'') as prd201920
...
WHERE (prd201516.group IS NOT NULL OR prd201617.group IS NOT NULL OR prd201718.group IS NOT NULL OR prd201819.group IS NOT NULL OR prd201920.group IS NOT NULL ) ".$dealerpiece.$regionpiece.$branchpiece.$typepiece.$categorypiece.";";
		...
		if($includemainsheet == 'yes')
		{
			...
			$mySheet->getStyle('A3:S3')->applyFromArray($styleArray);
			
			//Merge the cell
			$mySheet->mergeCells('A1:S1');
...
//						->setCellValue('M'.$currentrow,'2014-15')
				...
				count(prd201920 = '".$group."' or null) as prd201920  from yearwise_customers group by state;";
				$result = runmysqlquery($query);
...
//						->setCellValue('M'.$currentrow,'2014-15')
				...
				$query = "select custype,count(prd201516 = '".$group."' or null) as prd201516,count(prd201617 = '".$group."' or null) as prd201617,
				 count(prd201718 = '".$group."' or null) as prd201718,count(prd201819 = '".$group."' or null) as prd201819,
				 count(prd201920 = '".$group."' or null) as prd201920 from yearwise_customers group by custype;";
				$result = runmysqlquery($query);
...
//						->setCellValue('M'.$currentrow,'2014-15')
				...
				count(prd201718 = '".$group."' or null) as prd201718,count(prd201819 = '".$group."' or null) as prd201819,
				count(prd201920 = '".$group."' or null) as prd201920 from yearwise_customers group by cuscategory;";
				$result = runmysqlquery($query);
...
//						->setCellValue('X'.$currentrow,'2014-15')
				...
				//Apply style for header Row
				$mySheet->getStyle('M'.$currentrow.':R'.$currentrow)->applyFromArray($styleArray);
...
//				$mySheet->getCell('AC'.$currentrow)->getCalculatedValue();
				...
				//Apply style for content Row
				$mySheet->getStyle('M'.$databeginrow.':R'.$currentrow)->applyFromArray($styleArrayContent);
			}
			if($branchwise == 'branchwise')
			{
				//Begin writing Branch wise 
...
//				$mySheet->getCell('AC'.$currentrow)->getCalculatedValue();
				//Apply style for content Row
				$mySheet->getStyle('M'.$databeginrow.':G'.$currentrow)->applyFromArray($styleArrayContent);
