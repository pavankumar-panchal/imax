                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            <td  class="active-leftnav1">Report - Customer Contact Details ( Label Format )</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    <tr>
                                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr>
                                            <td colspan="2" bgcolor="#f7faff"><fieldset style="border:1px solid #8AC5FF; padding:3px;">
                                              <legend>Active Customer:</legend>
                                              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                <tr>
                                                  <td width="14%" align="left"><label for="activecustome_yes">
                                                    <input type="radio" name="activecustomer_type" id="activecustome_yes" value="yes"  />
                                                    Yes</label></td>
                                                  <td width="12%" align="left"><label for="activecustome_no">
                                                    <input type="radio" name="activecustomer_type" id="activecustome_no" value="no"  />
                                                    No</label></td>
                                                  <td width="74%" align="left"><label for="activecustome_both">
                                      ...
                                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr bgcolor="#f7faff" >
                                            <td colspan="4" valign="top" bgcolor="#f7faff" align="left"><div style="height:200px; overflow:scroll">
                                          ...
                                          <tr><td colspan="3"bgcolor="#f7faff" ><table width="100%" border="0" cellspacing="0" cellpadding="5" style="border:solid 1px #8AC5FF">
  <tr>
    ...
    <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        <td align="left"><label>
          ...
          <td align="left"><div id="colordiv" style="display:block"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left">[
            <label>
