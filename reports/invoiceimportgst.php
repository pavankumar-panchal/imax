                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                                      ...
                                      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#FBF3DB" >
                                          <tr>
                                            <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="3" >
                                                ...
                                                <td width="4%" align="left" valign="middle"><strong>2021</strong></td>
                                             
                                                <td width="8%" align="left" valign="top"><select class="swiftselect-mandatory" style="width:70px;" id="frominvoicetype" name="frominvoicetype" onchange="invoicetype_cat(); hideinvoicetype();" onblur="invoice_cat()">
                                                <option selected="selected" value="" > SELECT </option>
                                                <option value="R">R</option>
                                                <option value="D">D</option>
                                              </select></td>
                                                    <td width="8%" align="left" valign="top"><select class="swiftselect-mandatory" style="width:70px;" id="fromstatetype" name="fromstatetype" onchange="state_cat()" onblur="invoice_cat()">
                                                <option selected="selected" value=""> SELECT </option>
                        ...
                        <input type="text" id="toinvoicetype" readonly="readonly" name="toinvoicetype" size="10"/>
                                                  </td>
                                                   <td width="2%" align="left" valign="top">
