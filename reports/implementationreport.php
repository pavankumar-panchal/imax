<?
	$query1 = "select slno,branchname from inv_mas_branch group by branchname order by branchname";
	$result = runmysqlquery($query1);
	$grid .= '<table width="100%" border="0" cellspacing="0" cellpadding="5" class="imp_table-border">';
	$grid .= '<tr class="imp_tr-grid-header">';
	$grid .= '<td width="50%" align="center" class="imp_td-border">Branch</td>';
	$grid .= '<td width="50%" align="center" class="imp_td-border">Count</td>';
	$grid .= '</tr>';
	$count = 0;
	while($fetchcount = mysqli_fetch_array($result))
	{
		$count++;
		$grid .= '<tr>';
		$grid .= '<td  align="left" class="imp_td-border imp_fontstyle2">'.$fetchcount['branchname'].'</td>';
		$grid .= '<td  class="imp_td-border" align="center" >
		<span class="imp_fontstyle1"  id="'.$fetchcount['branchname'].'"></span></td>';
		$grid .= '</tr>';
	}
	$branchcount = $count;
	$grid .= '<tr>';
	$grid .= '<td  align="left" class="imp_td-border imp_fontstyle2" bgcolor="#D3D3D3" ><strong>Total Due</strong></td>';
	$grid .= '<td  align="center" class="imp_td-border" bgcolor="#D3D3D3" style="font-weight:bold" ><span id="total_branchdue" class="imp_fontstyle1" ></span></td>';
	$grid .= '</tr>';
	$grid .= '</table>';
	...
	$branchsalegrid = "";
	$count1 = 0;
	$branchgrid = '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-border-grid">';
	$branchsalegrid = '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-border-grid">';
	while($fetchcount1 = mysqli_fetch_array($result1))
	{
		$count1++;
		if($count1 == 1)
		{
			//fetch table row for Branch - Implementer Wise
			$tabgroupgrid = 'tabgroupgridh'.$count1;
			$branchgrid .= '<tr ><td  style="text-align:left;padding-left:5px" id=\''.$tabgroupgrid.'\' nowrap="nowrap" onclick = "gridtabvertical(\''.$count1.'\',\'tabgroupgrid\');displaybranch(\''.$fetchcount1['slno'].'\');" style="cursor:pointer;" class= "td-border-grid imp_grid-active-tabclass imp_fontstyle2">'.$fetchcount1['branchname'].'</td></tr>';
			
			//fetch table row for Branch - Sale Wise
			$tabgroupgrid1 = 'tabgroupnamegridh'.$count1;
			$branchsalegrid .= '<tr ><td  style="text-align:left;padding-left:5px" id=\''.$tabgroupgrid1.'\' nowrap="nowrap" onclick = "gridtabvertical5(\''.$count1.'\',\'tabgroupnamegrid\');displaybranchsaleswise(\''.$fetchcount1['slno'].'\');" style="cursor:pointer" class= "td-border-grid imp_grid-active-tabclass imp_fontstyle2">'.$fetchcount1['branchname'].'</td></tr>';
		...
		else
		{
			//fetch table row for Branch - Implementer Wise
			$tabgroupgrid = 'tabgroupgridh'.$count1;
			$branchgrid .= '<tr ><td  style="text-align:left;padding-left:5px" id=\''.$tabgroupgrid.'\' nowrap="nowrap" onclick = "gridtabvertical(\''.$count1.'\',\'tabgroupgrid\');displaybranch(\''.$fetchcount1['slno'].'\');" style="cursor:pointer;" class= "td-border-grid imp_grid-tabclass imp_fontstyle2">'.$fetchcount1['branchname'].'</td></tr>';

			//fetch table row for Branch - Sale Wise
			$tabgroupgrid1 = 'tabgroupnamegridh'.$count1;
			$branchsalegrid .= '<tr ><td  style="text-align:left;padding-left:5px" id=\''.$tabgroupgrid1.'\' nowrap="nowrap" onclick = "gridtabvertical5(\''.$count1.'\',\'tabgroupnamegrid\');displaybranchsaleswise(\''.$fetchcount1['slno'].'\');" style="cursor:pointer" class= "td-border-grid imp_grid-tabclass imp_fontstyle2">'.$fetchcount1['branchname'].'</td></tr>';
			
		}
	}
	$branchgrid .= '</table>';
	$branchsalegrid .= '</table>';
...
<script language="javascript" src="../functions/getdistrictfunction-imp.php?dummy=<? echo (rand());?>"></script>
                                      ...
                                      <td><div style="display:block" align="justify" id="tabg1c1" >
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              ...
                                              <td width="13%" valign="top" align="right"><div onclick="getimpbranchduedatadetails('all');displaybranch('1');displaybranchsaleswise('1');gridtabvertical('1','tabgroupgrid');gridtabvertical5('1','tabgroupnamegrid');getimpalldatadetails('all');" ><img src="../images/imax-customer-refresh.jpg" alt="Refresh Data" title="Refresh Data Data" style="cursor:pointer" /><span class="resendtext">Refresh Data</span></div></td>
                                            </tr>
                                            <tr>
                                                                              ...
                                                                              <tr>
                                                                                <td width="31%" valign="top" style="border-right:1px solid #CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="6">
                                                                                    <tr>
                                                                                      ...
                                                                                      <td width="75%"><select name="region" class="swiftselect" id="region" style="width:180px;">
											...
											?>
                                                                                ...
                                                                                <td width="35%" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="6">
                                                                                    <tr>
                                                                                      ...
                                                                                      <td width="70%"   height="10" align="left" valign="top" ><select name="branch" class="swiftselect" id="branch" style="width:180px;">
                                                                                          <option value="">ALL</option>
                                              ...
                                              <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                  <tr valign="top">
                                                    <td width="48%" ><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td align="left" style="font-size:12px" ><strong>All Data</strong></td>
                                                        </tr>
                                                        <tr>
                                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="5" class="imp_table-border">
                                                              <tr class="imp_tr-grid-header">
                                                                <td width="34%" align="center" class="imp_td-border">Total Records</td>
                                                                <td width="33%" align="center" class="imp_td-border">Not created (Raw)</td>
                                                                <td width="33%" align="center" class="imp_td-border">Activated</td>
                                                              </tr>
                                                              <tr>
                                                                <td  align="center" class="imp_td-border" ><span id="alldata_total" class="imp_fontstyle"></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="alldata_raw" class="imp_fontstyle"></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="alldata_activate" class="imp_fontstyle"></span></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                    ...
                                                    <td width="48%" ><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td align="left" style="font-size:12px" ><strong>Active Records</strong></td>
                                                        </tr>
                                                        <tr>
                                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="5" class="imp_table-border">
                                                              <tr class="imp_tr-grid-header">
                                                                <td width="45%" align="center" class="imp_td-border">Total Active Records</td>
                                                                <td width="27%" align="center" class="imp_td-border">Due</td>
                                                                <td width="28%" align="center" class="imp_td-border">Completed</td>
                                                              </tr>
                                                              <tr>
                                                                <td  align="center" class="imp_td-border"><span  id="active_total" class="imp_fontstyle"></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="active_due" class="imp_fontstyle" ></span></td>
                                                                <td  align="center" class="imp_td-border" ><span id="active_completed" class="imp_fontstyle" ></span></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                  ...
                                                  <tr valign="top">
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td align="left" style="font-size:12px" ><strong>Implementation Due</strong></td>
                                                        </tr>
                                                        <tr>
                                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="5" class="imp_table-border">
                                                              <tr class="imp_tr-grid-header">
                                                                <td width="31%" align="center" class="imp_td-border">Total Due</td>
                                                                <td width="31%" align="center" class="imp_td-border">With Sales</td>
                                                                <td width="38%" align="center" class="imp_td-border">With Implementation</td>
                                                              </tr>
                                                              <tr>
                                                    ...
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td align="left" style="font-size:12px" ><strong>Region wise due</strong></td>
                                                        </tr>
                                                        <tr>
                                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="5" class="imp_table-border">
                                                              <tr class="imp_tr-grid-header">
                                                                <td width="25%" align="center" class="imp_td-border">Total Due</td>
                                                                <td width="25%" align="center" class="imp_td-border">BKG</td>
                                                                <td width="25%" align="center" class="imp_td-border">BKM</td>
                                                                <td width="25%" align="center" class="imp_td-border">CSD</td>
                                                              </tr>
                                                              <tr>
                                                                <td  align="center" class="imp_td-border"><span id="region_total" class="imp_fontstyle" ></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="region_bkg" class="imp_fontstyle" ></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="region_bkm" class="imp_fontstyle" ></span></td>
                                                                <td  align="center" class="imp_td-border"><span id="region_csd" class="imp_fontstyle" ></span></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                  ...
                                                  <tr valign="top">
                                                    ...
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td align="left" style="font-size:12px" ><strong>Branch Wise (Implementation Due)</strong></td>
                                                        </tr>
                                                        <tr>
                                                          <td ><? echo($grid);?></td>
                                                        </tr>
                                                  ...
                                                  <tr valign="top">
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                <td width="51%" height="35px" align="left" valign="middle"  style="font-size:12px; padding-bottom:5px" ><strong>Branch - Implementer  Wise</strong></td>
                                                                <td width="49%" height="35px" align="left"  valign="middle"  style="font-size:12px; padding-bottom:5px" ><span  id="tabdisplayerror"></span></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                        <tr >
                                                          <td width="40%" valign="top" ><? echo($branchgrid);?></td>
                                                    ...
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                <td width="51%" height="35px" align="left" valign="middle"  style="font-size:12px; padding-bottom:5px" ><strong>Branch - Sales person wise</strong></td>
                                                                <td width="49%" height="35px" align="left"  valign="middle"  style="font-size:12px; padding-bottom:5px" ><span  id="tabdisplaymsg"></span></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                        <tr >
                                                          <td width="40%" valign="top" ><? echo($branchsalegrid);?></td>
                                                          <td width="60%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                        ...
                                        <div style="display:none" align="justify" id="tabg1c2" >
                                          <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
											...
											?>
                                                                                                ...
                                                                                                <tr>
                                                                                                  <td>State:</td>
                                                                                                  <td><select name="state" class="swiftselect" id="state" onchange="getdistrictfiltertype('districtcodedisplay',this.value);" onkeyup="getdistrictfiltertype('districtcodedisplay',this.value);" style="width:180px;">
                                                                                                      <option value="">ALL</option>
                                                                                                      <? include('../inc/state.php'); ?>
                                                                                                    </select></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                  <td>District:</td>
                                                                                                  <td align="left" valign="top"  id="districtcodedisplay" height="10" ><select name="district" class="swiftselect" id="district" style="width:180px;">
                                                                                                      <option value="">ALL</option>
                                                                                                    </select></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                  <td>Branch:</td>
                                                                                                  <td   height="10" align="left" valign="top" ><select name="branch2" class="swiftselect" id="branch2" style="width:180px;">
                                                                                                      <option value="">ALL</option>
                                                                                                      <? include('../inc/branch.php');?>
                                                                                                    </select></td>
                                                                                                </tr>
