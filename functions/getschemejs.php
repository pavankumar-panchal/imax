...
include('../functions/phpfunctions.php');
	...
	while($fetchscheme = mysqli_fetch_array($resultscheme))
	{
		...
		$query = "select distinct  inv_mas_scheme.todate,inv_mas_scheme.slno,inv_mas_scheme.schemename from inv_mas_scheme 
	left join inv_schememapping on inv_mas_scheme.slno = inv_schememapping.scheme where todate > CURDATE();";
