...
function formsubmit(command)
{
	...
	{
		passData =  "switchtype=delete&customerreference=" + encodeURIComponent($('#customerlist').val()) +  "&lastslno=" + encodeURIComponent($('#lastslno').val()) + "&dummy=" + Math.floor(Math.random()*100000000);
	}
