...
function productformsubmit(command)
{
	...
	if(field.val() <= '0')
	{ error.html(errormessage('You dont have enough credit, to get credit Contact Accounts depart.')); field.focus(); return false; }
	if(field.val() < $("#productamount").val())
 	{ error.html(errormessage('You dont have enough credit to purchase Product.')); field.focus(); return false; }
