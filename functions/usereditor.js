...
function formsubmit(command)
{
	...
	if($('#forcesurrender').is(':checked')== true) var forcesurrender = 'yes'; else var forcesurrender = 'no';
	if($('#surrenderreport').is(':checked')== true) var surrenderreport = 'yes'; else var surrenderreport = 'no';
	if($('#newtransferpin').is(':checked')== true) var newtransferpin = 'yes'; else var newtransferpin = 'no';
	...
	if($('#managedealerinvoice').is(':checked') == true) var managedealerinvoice = 'yes'; else var managedealerinvoice = 'no';
	if($('#dealerreceipts').is(':checked') == true) var dealerreceipts = 'yes'; else var dealerreceipts = 'no';
	...
	if($('#dealerreceiptreconciliation').is(':checked') == true) var dealerreceiptreconciliation = 'yes'; else var dealerreceiptreconciliation = 'no';
	...
	if($('#transactionsreport').is(':checked') == true) var transactionsreport = 'yes'; else var transactionsreport = 'no';
	...
	if($('#pindetails').is(':checked') == true) var pindetails = 'yes'; else var pindetails = 'no';
	//divya
	if($('#importinvoices').is(':checked') == true) var importinvoices = 'yes'; else var importinvoices = 'no';
	if($('#importreceipt').is(':checked') == true) var importreceipt = 'yes'; else var importreceipt = 'no';
	if($('#customuser').is(':checked') == true) var customuser = 'yes'; else var customuser = 'no';	
    if($('#mailamccustomer').is(':checked') == true) var mailamccustomer = 'yes'; else var mailamccustomer = 'no';
	if($('#addproductsnew').is(':checked') == true) var addproductsnew = 'yes'; else var addproductsnew = 'no';
	if($('#importinvoicesgst').is(':checked') == true) var importinvoicesgst = 'yes'; else var importinvoicesgst = 'no';
	if($('#autoreceiptreconsilation').is(':checked') == true) var autoreceiptreconsilation = 'yes'; else var autoreceiptreconsilation = 'no';
	if($('#transferredpinsreport').is(':checked') == true) var transferredpinsreport = 'yes'; else var transferredpinsreport = 'no';
	if($('#dealerinvoice_register').is(':checked') == true) var dealerinvoice_register = 'yes'; else var dealerinvoice_register = 'no';
	if($('#dealerbulkprintinvoice').is(':checked') == true) var dealerbulkprintinvoice = 'yes'; else var dealerbulkprintinvoice = 'no';
	if($('#matrix_invoicing').is(':checked') == true) var matrix_invoicing = 'yes'; else var matrix_invoicing = 'no';
	if($('#managematrixinvoice').is(':checked') == true) var managematrixinvoice = 'yes'; else var managematrixinvoice = 'no';
	if($('#matrixbulkprintinvoice').is(':checked') == true) var matrixbulkprintinvoice = 'yes'; else var matrixbulkprintinvoice = 'no';
	if($('#matrixinvoice_register').is(':checked') == true) var matrixinvoice_register = 'yes'; else var matrixinvoice_register = 'no';
		...
		ajaxcall3 = $.ajax(
		{
			...
			{	
				...
				else
				{
					...
					autochecknew($('#forcesurrender'),response[76]);
					autochecknew($('#surrenderreport'),response[77]);
					autochecknew($('#newtransferpin'),response[78]);
					autochecknew($('#transactionsreport'),response[79]);
					autochecknew($('#pindetails'),response[80]);
					autochecknew($('#importinvoices'),response[81]);
					autochecknew($('#importreceipt'),response[82]);
					autochecknew($('#importinvoicesgst'),response[86]);
					autochecknew($('#customuser'),response[83]);
		
                    autochecknew($('#mailamccustomer'),response[84]);
                    autochecknew($('#addproductsnew'),response[85]);
                    autochecknew($('#autoreceiptreconsilation'),response[87]);
                    autochecknew($('#transferredpinsreport'),response[88]);
					autochecknew($('#managedealerinvoice'),response[89]);
					autochecknew($('#dealerreceipts'),response[90]);
					autochecknew($('#dealerreceiptreconciliation'),response[91]);
					autochecknew($('#dealerinvoice_register'),response[92]);
					autochecknew($('#dealerbulkprintinvoice'),response[93]);
					autochecknew($('#matrix_invoicing'),response[94]);
					autochecknew($('#managematrixinvoice'),response[95]);
					autochecknew($('#matrixbulkprintinvoice'),response[96]);
					autochecknew($('#matrixinvoice_register'),response[97]);
					if(response[42] == 'n' )
					{
