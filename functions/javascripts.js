...
function tabopen5_new(activetab,tabgroupname)
{
	var totaltabs = 3;
	var activetabheadclass = "producttabheadactive";
	var tabheadclass = "producttabhead";
...
function validatelength(value,stategstcode) {
 var enteredchars = value.length;
 if(enteredchars != '15')
 {
    return false; 
 }
...
// 	var regularexp = '/^(\d{2})(\d{2})(\d{2})(\d{1})(\d{2})$/';
//     var regstring = ('000000000' + num).slice(-9);
// 	n = regstring.match(regularexp);
//     if(!n) return; 
