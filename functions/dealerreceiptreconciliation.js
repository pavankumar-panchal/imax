...
function receiptsearchsettings()
{
	...
	queryString = "../ajax/dealerreceiptreconciliation.php";
	ajaxcall5 = $.ajax(
	{
...
function searchfilter(startlimit)
{
	...
	var queryString = "../ajax/dealerreceiptreconciliation.php";
	ajaxcall3 = $.ajax(
	{
		type: "POST",url: queryString, data: passData, cache: false,
		success: function(ajaxresponse,status)
...
function generatetooltip(slno)
{
  ...
  else
  {
	...
	var queryString = "../ajax/dealerreceiptreconciliation.php";//alert(passdata)
