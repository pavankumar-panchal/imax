...
function formsubmit(command)
{
	...
	else
	{
		...
		{
			error.html('');
			$('#submitform').attr("action","../reports/excelcontactdetails.php?id=view") ;
		...
		{
			error.html('');
			$('#submitform').attr("action","../reports/excelcontactdetails.php?id=toexcel");
			$('#submitform').submit();
		}
	}
}
...
function selectcheckbox(radioname,checkname)
{
	var selectionvalue = $('#'+radioname).is(':checked');
