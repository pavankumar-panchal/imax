...
function getimpalldatadetails(type)
{
	...
	else if(type  == 'search')
	{
		...
		var passdata = "switchtype=implalldata&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(type);//alert(passdata)
		...
		{	
			...
			else
			{
				...
				if(response[0] == 1)
				{
					...
					$('#active_total').html(response[4]);
					$('#active_due').html(response[5]);
					$('#active_completed').html(response[6]);
					if(type  == 'all')
					{
						document.getElementById("active_total").onclick = new Function('detailedactivegrid("totalactivatedata","all")');
						document.getElementById("active_due").onclick = new Function('detailedactivegrid("duedata","all")');
						document.getElementById("active_completed").onclick = new Function('detailedactivegrid("completeddata","all")');
					}
					else if(type  == 'search')
					{
						document.getElementById("active_total").onclick = new Function('detailedactivegrid("totalactivatedata","search")');
						document.getElementById("active_due").onclick = new Function('detailedactivegrid("duedata","search")');
						document.getElementById("active_completed").onclick = new Function('detailedactivegrid("completeddata","search")');
					}
					...
					$('#region_bkm').html(response[12]);
					$('#region_csd').html(response[13]);
					if(type  == 'all')
					{
						...
						document.getElementById("region_csd").onclick = new Function('detailedregionactivegrid("totalregcsddata","all")');
					}
					else if(type  == 'search')
					{
						...
						document.getElementById("region_csd").onclick = new Function('detailedregionactivegrid("totalregcsddata","search")');
					}
...
function getimpactivedatadetails()
{
	var form = $('#submitform');
	var passdata = "switchtype=implactivedata&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	...
	ajaxcall1 = $.ajax(
	{
		...
		{	
			...
			else
			{
				...
				if(response[0] == '1')
				{
					$('#active_total').html(response[1]);
					$('#active_due').html(response[2]);
					$('#active_completed').html(response[3]);
				}
				else
				{
					$('#form-error').html("No datas found to be displayed.");
...
//Function to display Implementation Due Records ------------------------------------------
function getimpduedatadetails()
{
	var form = $('#submitform');
	var passdata = "switchtype=implduedata&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall2 = $.ajax(
	{
		...
		{	
			...
			else
			{
				...
				if(response[0] == '1')
				{
					$('#implementation_total').html(response[1]);
					$('#implementation_sale').html(response[2]);
					$('#implementation_withimp').html(response[3]);
				}
				else
				{
					$('#form-error').html("No datas found to be displayed.");
...
//Function to display Region wise Due Records ------------------------------------------
function getimpregionduedatadetails()
{
	var form = $('#submitform');
	var passdata = "switchtype=implregionduedata&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall3 = $.ajax(
	{
		...
		{	
			...
			else
			{
				...
				if(response[0] == '1')
				{
					$('#region_total').html(response[1]);
					$('#region_bkg').html(response[2]);
					$('#region_bkm').html(response[3]);
					$('#region_csd').html(response[4]);
				}
				else
				{
					$('#form-error').html("No datas found to be displayed.");
...
//Function to display Status wise Due Records ------------------------------------------
function getimpstatusduedatadetails()
{
	var form = $('#submitform');
	var passdata = "switchtype=implstatusduedata&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall4 = $.ajax(
	{
		...
		{	
			...
			else
			{
				...
				if(response[0] == '1')
				{
					$('#status_branch').html(response[1]);
					$('#status_coordinatorapproval').html(response[2]);
					$('#status_coordinatorreject').html(response[3]);
					$('#status_pending').html(response[4]);
					$('#status_assigned').html(response[5]);
					$('#status_progess').html(response[6]);
					$('#status_completed').html(response[7]);
					$('#status_totaldue').html(response[8]);
				}
				else
				{
					$('#form-error').html("No datas found to be displayed.");
...
//Function to display Branch wise Due Records ------------------------------------------
function getimpbranchduedatadetails(type,typeselect)
{
	var form = $('#submitform');
	if(type  == 'all')
	{
		var passdata = "switchtype=implbranchduedata&dummy=" + Math.floor(Math.random()*100000000) + "&typeselect=" +encodeURIComponent(type);//alert(passdata)
	}
	else if(type  == 'search')
	{
		var c_value = '';
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=implbranchduedata&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(type);//alert(passdata)

	}
	//var passdata = "switchtype=implbranchduedata&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall1 = $.ajax(
	{
		...
		{	
			...
			else
			{
				...
				if(response[0] == 1)
				{
					var responsevalue = response[1].split('#*#');
					var responsevalue1 = response[3].split('$$$');
					var responsevalue3 = response[4].split('$#$');
					for( var i=0; i<responsevalue1.length; i++)
					{
						$('#'+responsevalue1[i]).html('0');
						if(type  == 'all')
						{
							document.getElementById(responsevalue1[i]).onclick = new Function('getdisplaybranchgrid("branch' + (i+(1*1)) + '","all")');
							document.getElementById("total_branchdue").onclick = new Function('getdisplaybranchgrid("totalbranchwisedue","all")');

						}
						else if(type  == 'search')
						{
							document.getElementById(responsevalue1[i]).onclick = new Function('getdisplaybranchgrid("branch' + (i+(1*1)) + '","search")');
							document.getElementById("total_branchdue").onclick = new Function('getdisplaybranchgrid("totalbranchwisedue","search")');

						}
					}
					for( var j=0; j<responsevalue3.length; j++)
					{
						for( var i=0; i<responsevalue1.length; i++)
						{
							if(responsevalue1[i] == responsevalue3[j])
							{
								$('#'+responsevalue1[i]).html(responsevalue[j]);
							}
						}
					}
					$('#total_branchdue').html(response[2]);
				}
				else
				{
					$('#form-error').html("No datas found to be displayed.");
...
function detailedgrid(type,typeselect)
{
	...
	else if(typeselect  == 'search')
	{
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=impdetailedgrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)
...
//Function to Active Records display Popup grid ------------------------------------------
function detailedactivegrid(type,typeselect)
{
	var form = $('#submitform');
	if(typeselect  == 'all')
	{
		var passdata = "switchtype=detailedactivegrid&typelist="+encodeURIComponent(type)+"&typeselect="+encodeURIComponent(typeselect)+"&dummy=" + Math.floor(Math.random()*100000000)//;alert(passdata)
	}
	else if(typeselect  == 'search')
	{
		var values = validatestatuscheckboxes();
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=detailedactivegrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)

	}	
	//var passdata = "switchtype=detailedactivegrid&type="+encodeURIComponent(type)+"&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall2222 = $.ajax(
	{
...
function detailedimplduegrid(type,typeselect)
{
	...
	else if(typeselect  == 'search')
	{
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=impdetailedimplduegrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)
...
//Function to Region wise due display Popup grid ------------------------------------------
function detailedregionactivegrid(type,typeselect)
{
	var form = $('#submitform');
	if(typeselect  == 'all')
	{
		var passdata = "switchtype=detailedregionduegrid&typelist="+encodeURIComponent(type)+"&typeselect="+encodeURIComponent(typeselect)+"&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	}
	else if(typeselect  == 'search')
	{
		var values = validatestatuscheckboxes();
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=detailedregionduegrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)

	}	
	//var passdata = "switchtype=detailedregionduegrid&type="+encodeURIComponent(type)+"&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall333 = $.ajax(
	{
...
function getdisplaystatusgrid(type,typeselect)
{
	...
	else if(typeselect  == 'search')
	{
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=displaystatusgrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)
...
//Function to Status wise display Popup grid ------------------------------------------
function getdisplaybranchgrid(type,typeselect)
{
	var form = $('#submitform');
	if(typeselect  == 'all')
	{
		var passdata = "switchtype=detailedbranchwisegrid&typelist="+encodeURIComponent(type)+"&typeselect="+encodeURIComponent(typeselect)+"&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	}
	else if(typeselect  == 'search')
	{
		var values = validatestatuscheckboxes();
		...
		var statuslist = c_value.substring(0,(c_value.length-1));
		var passdata = "switchtype=detailedbranchwisegrid&state=" + encodeURIComponent($("#state2").val())  + "&region=" +encodeURIComponent($("#region").val())+ "&district=" +encodeURIComponent($("#district2").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer").val()) + "&branch=" + encodeURIComponent($("#branch").val())+"&type=" +encodeURIComponent($("#type").val()) + "&category=" + encodeURIComponent($("#category").val())+ "&implementer=" + encodeURIComponent($("#implementer").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000) + "&typeselect=" +encodeURIComponent(typeselect) +"&typelist="+encodeURIComponent(type);//alert(passdata)

	}	
	//var passdata = "switchtype=detailedbranchwisegrid&type="+encodeURIComponent(type)+"&dummy=" + Math.floor(Math.random()*100000000);//alert(passdata)
	var queryString = "../ajax/implementationreport.php";//alert(passdata)
	$('#form-error').html(getprocessingimage());
	ajaxcall758 = $.ajax(
	{
...
function advancesearch()
{
	...
	var statuslist = c_value.substring(0,(c_value.length-1));
	var passdata = "switchtype=searchlist&state=" + encodeURIComponent($("#state").val())  + "&region=" +encodeURIComponent($("#region2").val())+ "&district=" +encodeURIComponent($("#district").val()) +  "&dealer=" +encodeURIComponent($("#currentdealer2").val()) + "&branch=" + encodeURIComponent($("#branch2").val())+"&type=" +encodeURIComponent($("#type2").val()) + "&category=" + encodeURIComponent($("#category2").val())+ "&implementer=" + encodeURIComponent($("#implementer2").val()) +  "&statuslist=" +encodeURIComponent(statuslist) + "&dummy=" + Math.floor(Math.random()*10054300000);//alert(passdata)
