...
function searchfilter()
{
	...
	var queryString = "../ajax/bulkprinting.php";
	ajaxcall1 = $.ajax(
	{
...
function formsubmitduplicate()
{
	...
	else
	{
		...
		$('#submitform').attr("action", "../ajax/bulkprintingpdfduplicate.php") ;
...
function resendinvoice(invoiceno,slno)
{
	...
	else
	{
		...
		if(confirmation)
		{
			...
			queryString = "../ajax/bulkprinting.php";
			ajaxcall2 = $.ajax(
			{
				type: "POST",url: queryString, data: passData, cache: false,
				success: function(ajaxresponse,status)
...
function generateservicedetails()
{
	...
	var queryString = "../ajax/bulkprinting.php";//alert(passData)
	$('#productdetailsgridc1_1').html(getprocessingimage());
	$('#productdetailsgridc1link').html('');
	ajaxcall8 = $.ajax(
	{
...
function formsubmit()
{
	...
	else
	{
		...
		$('#hiddenslno').val(searcharray);
		$('#submitform').attr("action", "../ajax/bulkprintingpdf.php") ;
		$('#submitform').attr( 'target', '_blank' );
		$('#submitform').submit();
	}
