...
{
	switch ($linkvalue) {
		case 'producttodealers':
			return '../main/producttodealers.php';
			break;
		case 'customer':
			return '../main/customer.php';
			break;
		case 'dealer':
			return '../main/dealer.php';
			break;
		case 'blockcancel':
			return '../cards/blockcancel.php';
			break;
		case 'transferpin':
			return '../cards/transferpin.php';
			break;
		case 'pindetails':
			return '../cards/pindetails.php';
			break;
		case 'product':
			return '../main/products.php';
			break;
		case 'usereditor':
			return '../usermanagement/usereditor.php';
			break;
		case 'bill':
			return '../main/bills.php';
			break;
		case 'home_dashboard':
			return '../home/dashboard.php';
			break;
		case 'mergecustomer':
			return '../main/mergecustomer.php';
			break;
		case 'cardsearch':
			return '../cards/cardsearch.php';
			break;
		case 'externalregistration':
			return '../external/index.php';
			break;
		case 'transfercards':
			return '../cards/transfer.php';
			break;
		case 'credits':
			return '../main/credit.php';
			break;
		case 'customeramc':
			return '../main/customeramc.php';
			break;
		case 'customuser':
			return '../main/customuser.php';
			break;
		case 'mailamccustomer':
			return '../main/mailtoamccustomer.php';
			break;
		case 'unauthorised':
			return '../usermanagement/unauthorised.php';
			break;
		case 'changepassword':
			return '../usermanagement/changepw.php';
			break;
		case 'registrationdetails':
			return '../reports/registration.php';
			break;
		case 'invoicedetails':
			return '../reports/invoicedetails.php';
			break;
		case 'productshippeddetails':
			return '../reports/productshipped.php';
			break;
		case 'cusinteraction':
			return '../main/cusinteraction.php';
			break;
		case 'mergecustomerlist':
			return '../main/mergercustomerlist.php';
			break;
		case 'testajax':
			return '../ajaxcheck/customer.php';
			break;
		case 'hardwarelock':
			return '../main/hardwarelock.php';
			break;
		case 'dealerdetails':
			return '../reports/dealerreport.php';
			break;
		case 'contactdetails':
			return '../reports/contactdetailsreport.php';
			break;
		case 'labelcontactdetails':
			return '../reports/labelsforcontactdetails.php';
			break;
		case 'cuscardattachreport':
			return '../reports/cuscardattachreport.php';
			break;
		case 'surrenderreport':
			return '../reports/surrenderreport.php';
			break;
		case 'transactionsreport':
			return '../reports/transactionsreport.php';
			break;
		case 'contactreport':
			return '../reports/contact.php';
			break;
		case 'updationduedetails':
			return '../reports/updationdue.php';
			break;
		case 'customerprofileupdate':
			return '../main/cusprofileupdate.php';
			break;
		case 'custpayment':
			return '../main/custpayment.php';
			break;
		case 'dealerprofileupdate':
			return '../main/dealerprofileupdate.php';
			break;
		case 'districtmapping':
			return '../main/districtmapping.php';
			break;
		case 'cusattachcard':
			return '../main/cusattachcard.php';
			break;
		case 'scheme':
			return '../main/scheme.php';
			break;
		case 'schemepricing':
			return '../main/schemepricing.php';
			break;
		case 'productmapping':
			return '../main/productmapping.php';
			break;
		case 'schememapping':
			return '../main/schememapping.php';
			break;
		case 'resentpwd':
			return '../main/resentpwd.php';
			break;
		case 'smsaccount':
			return '../main/smsaccount.php';
			break;
		case 'smscredits':
			return '../main/smscredits.php';
			break;
		case 'smsreceipt':
			return '../main/smsreceipt.php';
			break;
		case 'smsreceiptdealers':
			return '../main/smsreceiptdealers.php';
			break;
		case 'smsaccountdealers':
			return '../main/smsaccountdealers.php';
			break;
		case 'smscreditsdealers':
			return '../main/smscreditsdealers.php';
			break;
		case 'customerquotereq':
			return '../main/customerquotereq.php';
			break;
		case 'smscreditssummary':
			return '../main/smscreditssummary.php';
			break;
		case 'viewinvoice':
			return '../main/viewinvoice.php';
			break;
		case 'rcidataviewer':
			return '../main/rcidataviewer.php';
			break;
		case 'updationsummary':
			return '../reports/updationsummary.php';
			break;
		case 'crossproductdetails':
			return '../reports/crossproductreport.php';
			break;
		case 'crossproduct':
			return '../main/crossproductinfo.php';
			break;
		case 'updationdetailedreport':
			return '../reports/updationdetailedreport.php';
			break;
		case 'salessummary':
			return '../reports/salessummary.php';
			break;
		case 'charts':
			return '../charts/index.php';
			break;
		case 'deployment':
			return '../main/deployment.php';
			break;
		case 'invoicing':
			return '../main/invoicing.php';
			break;
		case 'receipts':
			return '../main/receipts.php';
			break;
		case 'invoiceregister':
			return '../main/invoiceregister.php';
			break;
		case 'dealerinvoiceregister':
			return '../main/dealerinvoiceregister.php';
			break;
		case 'receiptregister':
			return '../main/receiptregister.php';
			break;
		case 'outstandingregister':
			return '../main/outstandingregister.php';
			break;
		case 'managedealerinvoice':
			return '../main/updatedealerinvoice.php';
			break;
		case 'dealerreceipts':
			return '../main/dealerreceipts.php';
			break;
		case 'manageinvoice':
			return '../main/updateinvoice.php';
			break;
		case 'bulkprint':
			return '../main/bulkprinting.php';
			break;
		case 'implementation':
			return '../main/implementation.php';
			break;
		case 'ssmcallstats':
			return '../reports/ssm-callstats.php';
			break;
		case 'implementationsummary':
			return '../reports/implementationreport.php';
			break;
		case 'customeranalysis':
			return '../main/custdata.php';
			break;
		case 'implementationdetailed':
			return '../reports/implementationstatusreport.php';
			break;
		case 'receiptreconciliation':
			return '../main/receiptreconsilation.php';
			break;
		case 'dealerreceiptreconciliation':
			return '../main/dealerreceiptreconciliation.php';
			break;
		case 'activitylog':
			return '../main/activitylog.php';
			break;
		case 'notregistered':
			return '../reports/notregistered.php';
			break;
		case 'categorysummary':
			return '../reports/categorysummary.php';
			break;
		case 'addinvoices':
			return '../main/addinvoices.php';
			break;
		case 'addbills':
			return '../main/addbills.php';
			break;
		case 'invoiceimport':
			return '../reports/invoiceimport.php';
			break;
		case 'receiptimport':
			return '../reports/receiptimport.php';
			break;
		case 'dealerattachcard':
			return '../main/dealerattachcard.php';
			break;
		case 'importinvoicesgst':
			return '../reports/importinvoicesgst.php';
			break;
		case 'autoreceiptreconciliation':
			return '../main/autoreceiptreconcil.php';
			break;
		case 'newdealerdetails':
			return '../reports/dealerreportnew.php';
			break;
		case 'transferredpinsreport':
			return '../reports/transferredpinsreport.php';
			break;
		case 'dealerbulkprint':
			return '../main/dealerbulkprinting.php';
			break;
		case 'matrixinvoicing':
			return '../main/matrixinvoicing.php';
			break;
		case 'matrixreceipts':
			return '../main/matrixreceipts.php';
			break;
		case 'managematrixinvoice':
			return '../main/updatematrixinvoice.php';
			break;
		case 'matrixbulkprint':
			return '../main/matrixbulkprinting.php';
			break;
		case 'matrixinvoiceregister':
			return '../main/matrixinvoiceregister.php';
			break;
		default:
			return '../home/dashboard.php';
			break;
...
function getpagetitle($linkvalue)
{
	switch ($linkvalue) {
		case 'producttodealers':
			return 'Saral iMax : Product Mapping to Dealers';
			break;
		case 'customer':
			return 'Saral iMax : Customer Master';
			break;
		case 'dealer':
			return 'Saral iMax : Dealer Master';
			break;
		case 'blockcancel':
			return 'Saral iMax : Block / Cancel PIN Numbers';
			break;
		case 'transferpin':
			return 'Saral iMax : Transfer PIN Numbers';
			break;
		case 'pindetails':
			return 'Saral iMax : Pin Details';
			break;
		case 'product':
			return 'Saral iMax : Product Master';
			break;
		case 'usereditor':
			return 'Saral iMax : User Editor Screen';
			break;
		case 'bill':
			return 'Saral iMax : Purchase Screen';
			break;
		case 'mergecustomer':
			return 'Saral iMax : Merge Customer';
			break;
		case 'customuser':
			return 'Custom User';
			break;
		case 'mailamccustomer':
			return 'Mail AMC Customer';
			break;
		case 'mergecustomerlist':
			return 'Saral iMax : Merge Customer List';
			break;
		case 'home_dashboard':
			return 'Saral iMax : Dashboard';
			break;
		case 'cardsearch':
			return 'Saral iMax : PIN Number Search';
			break;
		case 'externalregistration':
			return 'Saral iMax : External Registration';
			break;
		case 'transfercards':
			return 'Saral iMax : Transfer PIN Numbers';
			break;
		case 'credits':
			return 'Saral iMax : Credits';
			break;
		case 'customeramc':
			return 'Saral iMax : Customer AMC';
			break;
		case 'hardwarelock':
			return 'Saral iMax : Hardware Lock';
			break;
		case 'unauthorised':
			return 'Saral iMax : Unauthorsed Viewer';
			break;
		//case 'logout': return 'Inventory : Logout'; break;
		case 'changepassword':
			return 'Saral iMax : Change Password';
			break;
		case 'registrationdetails':
			return 'Saral iMax : Registration Details';
			break;
		case 'invoicedetails':
			return 'Saral iMax : Invoice Details';
			break;
		case 'productshippeddetails':
			return 'Saral iMax : Product Shipped Details';
			break;
		case 'cusinteraction':
			return 'Saral iMax : Customer Interaction Details';
			break;
		case 'dealerdetails':
			return 'Saral iMax : Dealer Stock Details';
			break;
		case 'contactdetails':
			return 'Saral iMax : Customer Contact Details';
			break;
		case 'labelcontactdetails':
			return 'Saral iMax : Labels for Customer Contact Details';
			break;
		case 'cuscardattachreport':
			return 'Saral iMax : Customer PIN No Attached Details';
			break;
		case 'surrenderreport':
			return 'Saral iMax : Surrender Details';
			break;
		case 'transactionsreport':
			return 'Saral iMax : Transactions Details';
			break;
		case 'updationduedetails':
			return 'Saral iMax : Updation Due Details';
			break;
		case 'customerprofileupdate':
			return 'Saral iMax : Customer Profile Update';
			break;
		case 'custpayment':
			return 'Saral iMax : Customer Payment Request';
			break;
		case 'dealerprofileupdate':
			return 'Saral iMax : Dealer Profile Update';
			break;
		case 'districtmapping':
			return 'Saral iMax : District to Dealer';
			break;
		case 'cusattachcard':
			return 'Saral iMax : Attach PIN Number';
			break;
		case 'scheme':
			return 'Saral iMax : Scheme Screen';
			break;
		case 'schemepricing':
			return 'Saral iMax : Scheme Pricing Screen';
			break;
		case 'productmapping':
			return 'Saral iMax : Product to Dealer';
			break;
		case 'schememapping':
			return 'Saral iMax : Scheme to Dealer';
			break;
		case 'resentpwd':
			return 'Saral iMax : Change Password';
			break;
		case 'smsaccount':
			return 'Saral iMax : SMS Account to Customer';
			break;
		case 'smscredits':
			return 'Saral iMax : SMS Credits';
			break;
		case 'smsreceipt':
			return 'Saral iMax : SMS Receipt Customers';
			break;
		case 'smsreceiptdealers':
			return 'Saral iMax : SMS Receipt Dealers';
			break;
		case 'smsaccountdealers':
			return 'Saral iMax : SMS Account to Dealer';
			break;
		case 'smscreditsdealers':
			return 'Saral iMax : SMS Credits';
			break;
		case 'customerquotereq':
			return 'Saral iMax : Customer :Quote / Payment / Request Emails';
			break;
		case 'smscreditssummary':
			return 'Saral iMax : SMS Summary';
			break;
		case 'viewinvoice':
			return 'Saral iMax : Invoice Details';
			break;
		case 'rcidataviewer':
			return 'Saral iMax : RCI Data Viewer';
			break;
		case 'updationsummary':
			return 'Saral iMax : Updation Due Summary';
			break;
		case 'crossproductdetails':
			return 'Saral iMax : Cross Product Sales';
			break;
		case 'crossproduct':
			return 'Saral iMax : Cross Product Information';
			break;
		case 'updationdetailedreport':
			return 'Saral iMax : Customer Stats (Year Wise)';
			break;
		case 'salessummary':
			return 'Saral iMax : Sales Summary';
			break;
		case 'charts':
			return 'Saral iMax : Graphic Representation';
			break;
		case 'deployment':
			return 'Saral iMax : Implementation Master';
			break;
		case 'invoicing':
			return 'Saral iMax : Invoicing';
			break;
		case 'receipts':
			return 'Saral iMax : Receipts';
			break;
		case 'invoiceregister':
			return 'Saral iMax : Invoice Register';
			break;
		case 'dealerinvoiceregister':
			return 'Saral iMax : Dealer Invoice Register';
			break;
		case 'receiptregister':
			return 'Saral iMax : Receipt Register';
			break;
		case 'outstandingregister':
			return 'Saral iMax : Outstanding Register';
			break;
		case 'managedealerinvoice':
			return 'Saral iMax : Manage Dealer Invoices';
			break;
		case 'dealerreceipts':
			return 'Saral iMax : Dealer Receipts';
			break;
		case 'manageinvoice':
			return 'Saral iMax : Manage Invoices';
			break;
		case 'bulkprint':
			return 'Saral iMax : Bulk Print (Invoices)';
			break;
		case 'implementation':
			return 'Saral iMax : Implementation';
			break;
		case 'ssmcallstats':
			return 'Saral iMax : SSM Call Stats';
			break;
		case 'implementationsummary':
			return 'Report : Implementation Summary';
			break;
		case 'customeranalysis':
			return 'Report : Data Inaccuracy Report';
			break;
		case 'implementationdetailed':
			return 'Report : Implementation Detailed Report';
			break;
		case 'receiptreconciliation':
			return 'Saral iMax : Receipt Reconciliation';
			break;
		case 'dealerreceiptreconciliation':
			return 'Saral iMax : Dealer Receipt Reconciliation';
			break;
		case 'activitylog':
			return 'Saral iMax : Activity Log';
			break;
		case 'notregistered':
			return 'Report : Not registered(Ageing) Report';
			break;
		case 'categorysummary':
			return 'Report : Category Summary Report';
			break;
		case 'addinvoices':
			return 'Saral iMax : Add Invoices';
			break;
		case 'addbills':
			return 'Saral iMax : Add Bills';
			break;
		case 'invoiceimport':
			return 'Saral iMax : Invoice Import';
			break;
		case 'receiptimport':
			return 'Saral iMax : Receipt Import';
			break;
		case 'dealerattachcard':
			return 'Saral iMax : Attach PIN Number';
			break;
		case 'importinvoicesgst':
			return 'Saral iMax : Import Invoices for GST';
			break;
		case 'autoreceiptreconciliation':
			return 'Saral iMax : Auto Receipt Reconciliation';
			break;
		case 'newdealerdetails':
			return 'Saral iMax : Dealer Stock New Details';
			break;
		case 'transferredpinsreport':
			return 'Saral iMax : Transferred Pins Report';
			break;
		case 'dealerbulkprint':
			return 'Saral iMax : Dealer Bulk Print (Invoices)';
			break;
		case 'matrixinvoicing':
			return 'Saral iMax :Matrix Invoicing';
			break;
		case 'matrixreceipts':
			return 'Saral iMax :Matrix Receipts';
			break;
		case 'managemateixinvoice':
			return 'Saral iMax : Manage Matrix Invoices';
			break;
		case 'matrixbulkprint':
			return 'Saral iMax : Matrix Bulk Print (Invoices)';
			break;
		case 'matrixinvoiceregister':
			return 'Saral iMax : Matrix Invoice Register';
			break;
		default:
			return 'Saral iMax : Dashboard';
			break;
...
function getpageheader($linkvalue)
{
	switch ($linkvalue) {
		case 'producttodealers':
			return 'Product Mapping to Dealers';
			break;
		case 'customer':
		...
		case 'dealer':
			...
			break;
		case 'blockcancel':
			return 'Block / Cancel PIN Numbers';
			break;
		case 'transferpin':
			return 'Transfer PIN Numbers';
			break;
		case 'pindetails':
			return 'Pin Details';
			break;
		...
		case 'invoicedetails':
			...
			break;
		case 'productshippeddetails':
			return 'Product Shipped Details';
			break;
		case 'dealerdetails':
			return 'Dealer Stock Details';
			break;
		case 'contactdetails':
		...
		case 'labelcontactdetails':
			...
			break;
		case 'cuscardattachreport':
			return 'Customer Card Attached Details';
			break;
		case 'surrenderreport':
			return 'Surrender Details';
			break;
		case 'transactionsreport':
			return 'Transactions Details';
			break;
		case 'updationduedetails':
			return 'Updation Due Details';
			break;
		case 'customerprofileupdate':
		...
		case 'custpayment':
			...
			break;
		case 'dealerprofileupdate':
			return 'Dealer Profile Update';
			break;
		case 'districtmapping':
			return 'District to Dealer';
			break;
		case 'cusattachcard':
			return 'Attach PIN Number';
			break;
		case 'scheme':
			return 'Scheme Master';
			break;
		case 'schemepricing':
			return 'Scheme Pricing';
			break;
		case 'productmapping':
			return 'Product to Dealer';
			break;
		case 'schememapping':
			return 'Scheme to Dealer';
			break;
		case 'resentpwd':
			return 'Change Password';
			break;
		case 'smsaccount':
			return 'SMS Account to Customer';
			break;
		case 'smscredits':
			return 'SMS credits';
			break;
		case 'smsreceipt':
			...
			break;
		case 'smsreceiptdealers':
			return 'SMS Receipt to Dealers';
			break;
		case 'smsaccountdealers':
			return 'SMS Account to Dealer';
			break;
		case 'smscreditsdealers':
			return 'SMS credits';
			break;
		case 'customerquotereq':
			return 'Quote / Payment / Request Emails';
			break;
		case 'smscreditssummary':
			return 'SMS Summary';
			break;
		case 'viewinvoice':
			...
			break;
		case 'updationsummary':
			return 'Updation Due Summary';
			break;
		case 'rcidataviewer':
			return 'RCI Data Viewer';
			break;
		case 'updationdetailedreport':
			return ' Customer Stats (Year Wise)';
			break;
		case 'crossproductdetails':
			return 'Saral iMax : Cross Product Sales';
			break;
		...
		case 'salessummary':
			...
			break;
		case 'charts':
			return 'Graphic Representation';
			break;
		case 'deployment':
			return 'Implementation Master';
			break;
		case 'invoicing':
			return 'Invoicing';
			break;
		...
		case 'invoiceregister':
			...
			break;
		case 'dealerinvoiceregister':
			return 'Dealer Invoice Register';
			break;
		case 'receiptregister':
			return 'Receipt Register';
			break;
		case 'outstandingregister':
			return 'Outstanding Register';
			break;
		case 'managedealerinvoice':
			return 'Manage Dealer Invoices';
			break;
		case 'dealerreceipts':
			return 'Dealer Receipts';
			break;
		case 'manageinvoice':
			return 'Manage Invoices';
			break;
		case 'bulkprint':
			return 'Bulk Print (Invoices)';
			break;
		case 'implementation':
			return 'Implementation Process';
			break;
		case 'ssmcallstats':
			return 'SSM Call Stats';
			break;
		case 'implementationsummary':
			return 'Implementation Summary';
			break;
		case 'customeranalysis':
			return 'Data Inaccuracy Report';
			break;
		case 'implementationdetailed':
			return 'Implementation Detailed Report';
			break;
		case 'receiptreconciliation':
			return 'Receipt Reconciliation';
			break;
		case 'dealerreceiptreconciliation':
			return 'Dealer Receipt Reconciliation';
			break;
		case 'activitylog':
			return 'Activity Log';
			break;
		case 'notregistered':
			return 'Not registered(Ageing) Report';
			break;
		case 'categorysummary':
		...
		case 'dealerattachcard':
			...
			break;
		case 'importinvoicesgst':
			return 'Import Invoices for GST';
			break;
		case 'autoreceiptreconciliation':
			return 'Auto Receipt Reconciliation';
			break;
		case 'newdealerdetails':
			return 'Dealer Stock New Details';
			break;
		case 'transferredpinsreport':
			return 'Transferred Pins Report';
			break;
		case 'dealerbulkprint':
			return 'Dealer Bulk Print (Invoices)';
			break;
		case 'matrixinvoicing':
			return 'Matrix Invoicing';
			break;
		case 'matrixreceipts':
			return 'Matrix Receipts';
			break;
		case 'managematrixinvoice':
			return 'Manage Matrix Invoices';
			break;
		case 'matrixbulkprint':
			return 'Matrix Bulk Print (Invoices)';
			break;
		case 'matrixinvoiceregister':
			return 'Matrix Invoice Register';
			break;
		default:
			return 'Dashboard';
			break;
...
function getpaymentmode($mode)
{
	switch ($mode) {
		case 'cash':
			...
			break;
		case 'onlinetransfer':
			$modereturned = 'Online Transfer';
			break;
		case 'chequeordd':
			$modereturned = 'Cheque / DD';
			break;
		case 'creditordebit':
			$modereturned = 'Credit / Debit Card';
			break;
		case 'Netbanking':
			$modereturned = 'Online Transfer';
			break;
