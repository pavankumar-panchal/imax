                ...
                <?php if (($p_masterimplementation == 'yes') || ($p_createimplementation == 'yes')) { ?>
                  <li class="current"><A><span class="sf-menupointer">Implementation</span></A>
                    <UL>
                      ...
                      <?php } ?>
                      <li><a href="http://imax.relyonsoft.net/implementation/demo/" target="_blank">Video Tutorials </a>
                      </li>
                    </UL>
                  </li>
                <?php } ?>
                ...
                <UL>
                    ...
                    <li><A><span class="sf-menupointer" style="text-align:left">Invoicing</span></A>
                      <ul class="sf-menu">
                        <?php if ($p_invoicing == 'yes') {
                          echo '<li><a href="./index.php?a_link=invoicing">Product Invoicing</a></li>';
                        } ?>
                        <?php if ($p_matrixinvoicing == 'yes') {
                          echo '<li><a href="./index.php?a_link=matrixinvoicing">Matrix Invoicing</a></li>';
                        } ?>
                      </ul>
                    </li>
                  <?php } ?>
                  <?php if ($p_invoicing == 'yes' || $p_dealerreceipts == 'yes') { ?>
                    <li><A><span class="sf-menupointer" style="text-align:left">Receipts</span></A>
                      <ul class="sf-menu">
                        <?php if ($p_invoicing == 'yes') {
                          echo '<li><a href="./index.php?a_link=receipts">Customer Receipts</a></li>';
                        } ?>
                        <?php if ($p_dealerreceipts == 'yes') {
                          echo '<li><a href="./index.php?a_link=dealerreceipts">Dealer Receipts</a></li>';
                        } ?>
                        <?php if ($p_matrixinvoicing == 'yes') {
                          echo '<li><a href="./index.php?a_link=matrixreceipts">Matrix Receipts</a></li>';
                        } ?>
                      </ul>
                    </li>
                  <?php } ?>
                  <?php if ($p_dealerreceiptreconciliation == 'yes' || $p_autoreceiptreconsilation == 'yes' || $p_receiptreconsilation == 'yes') { ?>
                    <li><A><span class="sf-menupointer">Reconciliation</span></A>
                      <ul class="sf-menu">
                        <?php if ($p_dealerreceiptreconciliation == 'yes') {
                          echo '<li style="width:210px"><a href="./index.php?a_link=dealerreceiptreconciliation">Dealer Receipts Reconciliation</a></li>';
                        } ?>
                        <?php if ($p_autoreceiptreconsilation == 'yes') {
                          echo '<li style="width:210px"><a href="./index.php?a_link=autoreceiptreconciliation">Auto Receipts Reconciliation</a></li>';
                        } ?>
                        <?php if ($p_receiptreconsilation == 'yes') {
                          echo '<li  style="width:210px"><a href="./index.php?a_link=receiptreconciliation">Customer Receipts Reconciliation</a></li>';
                        } ?>
                      </ul>
                    </li>
                  <?php } ?>
                  ...
                  <?php if ($p_manageinvoice == 'yes' || $p_managedealerinvoice == 'yes' || $p_managematrixinvoice == 'yes') {
                    ...
                    if ($p_invoicing == 'yes') {
                      echo '<li><a href="./index.php?a_link=manageinvoice">Product Invoices</a> </li>';
                    }
                    if ($p_managedealerinvoice == 'yes') {
                      echo '<li><a href="./index.php?a_link=managedealerinvoice">Dealer Invoices</a> </li>';
                    }
                    if ($p_managematrixinvoice == 'yes') {
                      echo '<li><a href="./index.php?a_link=managematrixinvoice">Matrix Invoices</a> </li>';
                    }
                    echo '</ul></li>';
                  } ?>
                  <?php if ($p_dealerbulkprintinvoice == 'yes' || $p_bulkprintinvoice == 'yes' || $p_matrixbulkprintinvoice == 'yes') { ?>
                    <li><A><span class="sf-menupointer" style="text-align:left">Bulk Prints</span></A>
                      <ul class="sf-menu">
                        <?php if ($p_dealerbulkprintinvoice == 'yes') {
                          echo '<li><a href="./index.php?a_link=dealerbulkprint">Dealer Bulk Print (Invoices)</a></li>';
                        } ?>
                        <?php if ($p_bulkprintinvoice == 'yes') {
                          echo '<li><a href="./index.php?a_link=bulkprint">Product Bulk Print (Invoices)</a></li>';
                        } ?>
                        <?php if ($p_matrixbulkprintinvoice == 'yes') {
                          echo '<li><a href="./index.php?a_link=matrixbulkprint">Matrix Bulk Print (Invoices)</a></li>';
                        } ?>
                      </ul>
                    </li>
                  <?php } ?>
