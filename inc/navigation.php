          ...
          <ul class="sf-menu">
            ...
            <li class="current"><A>Customers</A>
              <UL><?php if(!in_array($userid, $auditorid, true)) { ?>
                ...
                <? } if(!in_array($userid, $auditorid, true)) { ?>
            ...
            <? if(($p_dealerreceipts == 'yes') || ($p_dealerreceiptreconciliation == 'yes') || ($p_invoicing == 'yes') || ($p_matrixinvoicing=='yes') || ($p_autoreceiptreconsilation == 'yes') || ($p_invoiceregister == 'yes') || ($p_dealerinvoiceregister == 'yes') || ($p_matrixinvoiceregister == 'yes') || $p_managematrixinvoice == 'yes' || $p_matrixbulkprintinvoice == 'yes' || ($p_receiptsregister == 'yes') || ($p_outstandingregister == 'yes')|| ($p_custpayment == 'yes') || ($p_bulkprintinvoice == 'yes') || ($p_dealerbulkprintinvoice == 'yes') || ($p_manageinvoice == 'yes') || ($p_managedealerinvoice == 'yes')|| ($p_addinvoice == 'yes') || ($p_importinvoices == 'yes' || $p_receiptreconsilation == 'yes') || ($p_importreceipt == 'yes')|| ($p_importinvoicesnew == 'yes')){ ?>
            <li class="current"><A>Billing</A>
              <UL>
                <? if($p_invoicing == 'yes' || $p_matrixinvoicing == 'yes') { ?>
                  <li ><A ><span class="sf-menupointer"  style="text-align:left">Invoicing</span></A>
                <ul class="sf-menu">
                <? if($p_invoicing == 'yes') { echo '<li><a href="./index.php?a_link=invoicing">Product Invoicing</a></li>'; } ?>
                <? if($p_matrixinvoicing == 'yes') { echo '<li><a href="./index.php?a_link=matrixinvoicing">Matrix Invoicing</a></li>'; } ?>
                </ul></li>
                <? } ?>
                <? if($p_invoicing == 'yes' || $p_dealerreceipts == 'yes') { ?>
                <li ><A ><span class="sf-menupointer"  style="text-align:left">Receipts</span></A>
                  <ul class="sf-menu">
                  <? if($p_invoicing == 'yes') { echo '<li><a href="./index.php?a_link=receipts">Customer Receipts</a></li>'; } ?>
                  <? if($p_dealerreceipts == 'yes') { echo '<li><a href="./index.php?a_link=dealerreceipts">Dealer Receipts</a></li>'; } ?>
                  <? if($p_matrixinvoicing == 'yes') { echo '<li><a href="./index.php?a_link=matrixreceipts">Matrix Receipts</a></li>'; } ?>
                </ul></li>
                  <? } ?>
                  <? if($p_dealerreceiptreconciliation == 'yes' || $p_autoreceiptreconsilation == 'yes' || $p_receiptreconsilation == 'yes') { ?>
                <li ><A ><span class="sf-menupointer">Reconciliation</span></A>
                  <ul class="sf-menu">
                  <? if($p_dealerreceiptreconciliation == 'yes') { echo '<li style="width:210px"><a href="./index.php?a_link=dealerreceiptreconciliation">Dealer Receipts Reconciliation</a></li>'; } ?>
                  <? if($p_autoreceiptreconsilation == 'yes') { echo '<li style="width:210px"><a href="./index.php?a_link=autoreceiptreconciliation">Auto Receipts Reconciliation</a></li>'; } ?>
                  <? if($p_receiptreconsilation == 'yes') { echo '<li  style="width:210px"><a href="./index.php?a_link=receiptreconciliation">Customer Receipts Reconciliation</a></li>'; } ?>
                </ul></li>
                  <? } ?>
                     <? if($p_addinvoice == 'yes') { ?>
                 <li><a href="./index.php?a_link=addinvoices">Add Invoices</a> </li>
                <? } ?>
                <? if(($p_invoiceregister == 'yes') || ($p_matrixinvoiceregister == 'yes') || ($p_dealerinvoiceregister == 'yes') || ($p_receiptsregister == 'yes') || ($p_outstandingregister == 'yes')) { ?>
                <li ><A ><span class="sf-menupointer"  style="text-align:left">Registers</span></A>
                  <ul class="sf-menu">
                    ...
                    <? } ?>
                    <? if($p_dealerinvoiceregister == 'yes') { ?>
                ...
                <? } ?>
                <? if($p_manageinvoice == 'yes' || $p_managedealerinvoice == 'yes' || $p_managematrixinvoice == 'yes') { 
                ...
                <? if($p_dealerbulkprintinvoice == 'yes' || $p_bulkprintinvoice == 'yes' || $p_matrixbulkprintinvoice == 'yes') { ?>
                  <li ><A ><span class="sf-menupointer"  style="text-align:left">Bulk Prints</span></A>
                <ul class="sf-menu">
                <? if($p_dealerbulkprintinvoice == 'yes') { echo '<li><a href="./index.php?a_link=dealerbulkprint">Dealer Bulk Print (Invoices)</a></li>'; } ?>
                <? if($p_bulkprintinvoice == 'yes') { echo '<li><a href="./index.php?a_link=bulkprint">Product Bulk Print (Invoices)</a></li>'; } ?>
                <? if($p_matrixbulkprintinvoice == 'yes') { echo '<li><a href="./index.php?a_link=matrixbulkprint">Matrix Bulk Print (Invoices)</a></li>'; } ?>
                </ul></li>
                <? } ?>
