          ...
          <ul class="sf-menu">
            ...
            <li class="current"><A>PIN Numbers</A>
              <UL>
                ...
                <?php } ?>
                <!--           <?php //if($p_transfercard == 'yes') { ?>
                <li><a  href="./index.php?a_link=transfercards">Transfer Cards</a> </li>
                <?php //} ?>-->
              </UL>
            </li>
            <?php if(($p_invoicing == 'yes') ||($p_invoiceregister == 'yes') ||($p_receiptsregister == 'yes') || ($p_outstandingregister == 'yes')|| ($p_custpayment == 'yes') || ($p_bulkprintinvoice == 'yes') || ($p_manageinvoice == 'yes')|| ($p_addinvoice == 'yes') || ($p_importinvoices == 'yes' || $p_receiptreconsilation == 'yes')){ ?>
