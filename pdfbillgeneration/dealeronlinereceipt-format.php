...
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" >
  ...
  <tr bgcolor="#CCCCCC">
    <td width="60%" colspan="2" ><div align="left"><strong>Dealer Details</strong></div></td>
    <td width="40%"><div align="left"><strong>Receipt Details</strong></div></td>
  </tr>
  <tr>
    <td width="60%" colspan="2" style="text-align:left"><strong>Receipt No:</strong> <span style="text-align:right">##SLNO##</span></td>
    <td style="text-align:left" width="40%"><strong>Date:</strong> ##RECEIPTDATE##</td>
  </tr>
  <tr>
    <td  colspan="3" style="text-align:left"><strong>##BUSINESSNAME##</strong></td>
  </tr>
  <tr>
    <td colspan="3" style="text-align:left">##ADDRESS##</td>
  </tr>
  <tr>
    <td colspan="3" style="border:none;" height="50px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
     
      <tr>
        <td style="font-size:9px"><div align="justify">
          <p>Received with thanks from <strong>##BUSINESSNAME##</strong> of<img src="../images/relyon-rupee-small.jpg" alt="" width="8" height="8" border="0" align="absmiddle" /> ##AMOUNT## for Saralimax Credit to Relyon Accounts Department.</p>
          <p><strong>Amount in words</strong>: Rupees ##AMOUNTINWORDS## only </p>
         
          </div></td>
      </tr>
      <tr>
        <td style="font-size:9px"><div align="justify"><strong>Mode of Payment:</strong> ##MODE##</div></td>
      </tr>
      <!-- <tr>
        <td style="font-size:9px"><div align="justify"><strong>Payment details:</strong>##REMARKS##</div></td>
      </tr> -->
       <tr>
        <td>&nbsp;</td>
      </tr>
