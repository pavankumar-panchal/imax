    ...
    <td colspan="3" style="border:none;" height="50px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="font-size:9px"><div align="justify">
          <p>Received with thanks from <strong>##BUSINESSNAME##</strong> for<img src="../images/relyon-rupee-small.jpg" alt="" width="8" height="8" border="0" align="absmiddle" /> ##AMOUNT## </p>
