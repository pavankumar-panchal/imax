...
<script type="text/javascript" src="../functions/dealerinvoiceregister.js?dummy=<?php echo (rand());?>"></script>
											...
											?>
                                                                          ...
                                                                          <tr>
                                                                            ...
                                                                            <td align="left" valign="top"   height="10" ><select name="generatedby" class="swiftselect" id="generatedby" style="width:180px;">
                                                                                <option value="">ALL</option>
                                                                                <?php $query = "(select distinct CONCAT(inv_mas_users.slno,'^[U]') as slno,CONCAT(UPPER(inv_mas_users.fullname) ,'  [U]') as name 
                                                                          ...
                                                                          <tr>
                                                                            <td height="10" align="left">Usage Type:</td>
                                                                            <td align="left" valign="top"   height="10" ><select style="width: 180px;" id="usagetype" class="swiftselect" name="usagetype">
                                                                                <option value="" selected="selected">ALL</option>
                                                                                <option value="singleuser">SINGLE USER</option>
                                                                                <option value="multiuser">MULTI USER</option>
                                                                                <option value="addlic">ADDITIONAL LICENSE</option>
                                                                              </select></td>
                                                                          </tr>
                                                                          <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td  width="50%" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                            ...
                                                            <tr>
                                                              <td ><div id="itemsothersdiv" style="padding-left:4px"></div></td>
                                                            </tr> -->
                                                          </table></td>
                                                        <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                            <tr>
                                                              <td><div align="center"><strong>Items (Service)</strong></div></td>
                                                            </tr>
                                                            <tr>
