                                                                                ...
                                                                                <tr>
                                                                                  <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3" >
                                                                                      ...
                                                                                      <tr height="25px">
                                                                                        ...
                                                                                        <td bgcolor="#edf4ff"><span id="regiondisplay" class="contacttext" onClick="getselectiontype('region')" ></span></td>
                                                                                      </tr>
                                                                                      <tr height="25px">
                                                                                        <td bgcolor="#F7FAFF">Branch:</td>
                                                                                        <td bgcolor="#F7FAFF"><span id="branchdisplay" class="contacttext" onClick="getselectiontype('branch')" ></span></td>
                                                                                      </tr>
                                                                                      <tr height="25px">
                                                                                        <td bgcolor="#edf4ff">Current Dealer:</td>
                                                                                        <td bgcolor="#edf4ff"><span id="currentdealerdisplay" class="contacttext" onClick="getselectiontype('currentdealer')" ></span></td>
                                                                                      </tr>
                                                                                      <tr height="25px">
                                      ...
                                      <td><div  id='displaystategrid' style='background:#fff; width:550px'>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border:solid 1px #DDEEFF">
                                            ...
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" ><select name="state" class="swiftselect-mandatory type_enter focus_redclass" id="state" onchange="getdistrict('districtcodedisplay',this.value);" onkeyup="getdistrict('districtcodedisplay',this.value);"  style="width:200px;">
                                            ...
                                            <tr>
                                              ...
                                              <td valign="top" align="left" id="districtcodedisplay"><select name="district" class="swiftselect-mandatory type_enter focus_redclass" id="district" style="width:200px;">
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border:solid 1px #DDEEFF">
                                           <tr>
                                            ...
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td width="73%" align="left" valign="top" bgcolor="#f7faff" ><input type="checkbox" name="activecustomer" id="activecustomer" class="type_enter focus_redclass" /></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" bgcolor="#edf4ff" ><input type="checkbox" name="disablelogin" id="disablelogin" class="type_enter focus_redclass" /></td>
                                            </tr>
                                            <tr>
                                              ...
                                              <td align="left" valign="top" bgcolor="#F7FAFF"><input type="checkbox" name="corporateorder" id="corporateorder" class="type_enter focus_redclass"/></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" bgcolor="#edf4ff"><input type="checkbox" name="companyclosed" id="companyclosed" class="type_enter focus_redclass"/></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td valign="top" align="left"><input type="checkbox" name="isdealer" id="isdealer" class="type_enter focus_redclass"/></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" bgcolor="#edf4ff"><input type="checkbox" name="displayinwebsite" id="displayinwebsite" class="type_enter focus_redclass"/></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" bgcolor="#f7faff"><input type="checkbox" name="promotionalsms" id="promotionalsms" class="type_enter focus_redclass" /></td>
                                            </tr>
                                            <tr bgcolor="#f7faff">
                                              ...
                                              <td align="left" valign="top" bgcolor="#edf4ff"><input type="checkbox" name="promotionalemail" id="promotionalemail" class="type_enter focus_redclass generallastfield"/></td>
                                            </tr>
                                            <tr><td colspan="2" height="10px"></td></tr>
                                            <tr>
                                              <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
