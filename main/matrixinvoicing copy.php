        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2"><form id="filterform" name="filterform" method="post" action="" onsubmit="return false;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr>
                        <td colspan="2" align="left" ><input name="detailsearchtext" type="text" class="swifttext" id="detailsearchtext" onkeyup="customersearch(event);"  autocomplete="off" style="width:169px"/>
                          ...
                          <div id="detailloadcustomerlist">
                            <select name="customerlist" size="5" class="swiftselect" id="customerlist" style="width:175px; height:400px" onclick ="selectfromlist();" onchange="selectfromlist();"  >
                            </select>
                          </div></td>
                      </tr>
                    </table>
              ...
              <tr>
                ...
                <td width="40%" id="totalcount" align="left"></td>
              </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
                            ...
                            <td colspan="2" valign="top"><div id="maindiv">
                                <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#f7faff">
                                    ...
                                    <tr>
                                      <td colspan=2>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3" style="color:#646464; font-weight:bold">
                                      <tr>
                                      <td width="1%">&nbsp;</td>
                                      <td width="2%"><div align="center;">Purchase Type</div></td>
                                      <td width="9%"><div align="center;">Product Type</div></td>
                                      <td width="2%""><div align="center;">Product Qty</div></td>
                                      <td width="6%""><div align="center;">Unit Amt</div></td>
                                      <td width="6%""><div align="center;">Invoice Amt</div></td>
                                      <td width="6%""><div align="center;">Serial Qty</div></td>
                                            ...
                                            <tr>
                                              ...
                                              <td width="9%"><select name="producttype[]" class="swiftselect-mandatory producttype" id="producttype1" style="width:140px;" onchange="getproductname(this)">
                                                ...
                                                <?php 
                                                  ...
                                                  <td width="2%">
                                                  <input type="number" class="swifttext-mandatory" name="quantity[]" id="quantity1" placeholder="Qty" name="quantity" style="width:50px" min="1" onkeyup="getSerialDiv(this);" onchange="getSerialDiv(this);">
                                                  </td>
                                                  ...
                                                  <td width=6%">
                                                    <input name="srlqty[]" class="swifttext-mandatory" id="srlqty1" placeholder="" value="0" size="5" onkeyup="getSerialDiv(this);" onchange="getSerialDiv(this);" />
                                                  </td>
