...
$query = "select min(left(inv_invoicenumbers.createddate,10)) as fromdate from inv_invoicenumbers";
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="25%" align="top" class="active-leftnav">Manage Invoices</td>
                            <td width="34%" align="top"><div align="right"> <font color="#FF6B24">Customer ID?</font></div></td>
                                            ...
                                            <tr>
                                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                  <tr>
                                                    ...
                                                    <td width="43%"><input name="filter" type="button" class="swiftchoicebutton-red" id="filter" value="Search" onclick="searchcustomerarray();" />
                                                      &nbsp;
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                          <tr>
                            <td align="left" class="header-line" style="padding:0"> Edit / Cancel Invoice</td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                                          <!-- <td width="18%"></td> -->
                                                          <td width="17%"><div align="right"><a   onclick="resendinvoice(document.getElementById('lastslno').value);"  class="r-text" >Resend Invoice &gt;&gt;</a></div></td>
                                                          <td width="15%"><div align="right"><a   onclick="viewinvoice(document.getElementById('lastslno').value)"  class="r-text" >View Invoice &gt;&gt;</a></div></td>
                                                          <td width="15%">
