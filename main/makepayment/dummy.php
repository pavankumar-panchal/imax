...
if($ResponseCode == 0) //Success
{
	...
	$query1 = "UPDATE dealer_online_purchase SET  paymentdate = '".date('Y-m-d')."', paymenttime = '".date('H:i:s')."',paymenttypeselected = 'paymentmadenow' WHERE onlineinvoiceno  = '".$recordreferencestring."'";
