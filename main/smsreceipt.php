...
<script language="javascript" src="../functions/smsreceipts.js?dummy=<?php echo (rand());?>"></script>
                                    ...
                                    <tr>
                                      ...
                                      <tr bgcolor="#f7faff">
                                           ...
                                           <label> <input type="radio" name="paymentmode" id="cheque" value="cheque" checked="checked"/>
                                            ...
                                            NEFT<br/> </label>
                                           <label> <input type="radio" name="paymentmode" id="onlinepayment" value="Online Payment" />
