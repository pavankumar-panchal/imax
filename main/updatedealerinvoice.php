...
$query = "select min(left(inv_dealer_invoicenumbers.createddate,10)) as fromdate from inv_dealer_invoicenumbers";
...
<script language="javascript" src="../functions/updatedealerinvoice.js?dummy=<?php echo(rand());?>"></script>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                                          <td width="17%"><div align="right"><a   onclick="resenddealerinvoice(document.getElementById('lastslno').value);"  class="r-text" >Resend Invoice &gt;&gt;</a></div></td>
                                                          <td width="15%"><div align="right"><a   onclick="viewdealerinvoice(document.getElementById('lastslno').value)"  class="r-text" >View Invoice &gt;&gt;</a></div></td>
                                                          <td width="15%">
