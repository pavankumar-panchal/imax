                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            <td width="41%" align="left" valign="middle" class="active-leftnav"> Credit Amount: Rs. <span id="creditamountdisplay"></span></td>
                                            ...
                                            <tr>
                                              <td width="100%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                  <tr>
                                                    ...
                                                    <td width="34%" align="left" valign="top" bgcolor="#F7FAFF"><input type="text" class="swifttext-mandatory" id="DPC_attacheddate" size="20" autocomplete="off" value="" /></td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td colspan="4" valign="top" bgcolor="#F7FAFF" style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="3" style="border:1px solid #333333;">
                                                        <tr>
                                                          ...
                                                          <td width="39%" align="left" id="displayschemecode"><select name="scheme" class="swiftselect-mandatory" id="scheme" style="width:200px" onclick="getproduct('displayproductcode',this.value);" >
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td align="left" id="displayproductcode"><select name="productcode" class="swiftselect-mandatory" id="productcode" style="width:200px;" onchange="getamount();">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td align="left" valign="top"><input name="productquantity" type="text" class=" swifttext-mandatory" id="productquantity" onkeyup="getamount(); " size="10" maxlength="4"  autocomplete="off"/>
                                                              ...
                                                              <input type="hidden" name="cardslnolist" id="cardslnolist" value="" /></td>
                                                          <td width="15%" align="left">Amount:</td>
                                                          <td width="31%" align="left"><input name="productamount" type="text" class=" swifttext-mandatory" id="productamount" size="30" maxlength="12"  autocomplete="off" /></td>
                                                        </tr>
                                                        <tr>
                                                          <td><strong>PIN No</strong></td>
                                                          <td colspan="3"><input name="pinno" type="text" class=" swifttext-mandatory" id="pinno" size="100" maxlength="1000"  autocomplete="off" /></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                          <td colspan="4"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                <td width="71%" height="35" align="left" valign="middle"><div id="prd-form-error"></div></td>
                                                                <td width="29%" height="35" align="center" valign="middle">&nbsp;
                                                  ...
                                                  <tr>
                                                    <td colspan="4" bgcolor="#F7FAFF"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc;">
                                                        <tr>
                                                          <td width="15%" style="padding:0"><div id="displayproductresult" style="overflow:auto; height:150px;  width:690px; padding:2px;" align="center">No datas found to be displayed.</div> </td>
                                                      </tr>
                                                    </table></td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td colspan="4" bgcolor="#F7FAFF"><table width="98%" border="0" cellspacing="0" cellpadding="0" >
                                                        <tr>
                                                          <td width="46%" height="35" align="left" valign="middle"><div id="form-error"></div>
                                                              <div id="save-form-error"></div></td>
                                                          <td width="54%" height="35" align="right" valign="middle"><div align="left">
