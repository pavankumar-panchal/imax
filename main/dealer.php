                          ...
                          <td colspan="2" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                              <tr>
                                ...
                                <td align="left" bgcolor="#F7FAFF"><input name="businessname" type="text" class="swifttext-mandatory" id="businessname" size="70" maxlength="100" autocomplete="off"  />
                                  ...
                                  <tr>
                                      <td align="left" bgcolor="#edf4ff">Dealer Type:</td>
                                      <td align="left" bgcolor="#edf4ff"><select name="dealertype" id="dealertype" class="swiftselect-mandatory" onchange="changedealertype()">
                                              <option value="">Select Dealer Type</option>
                                              <option value="msp">MSP</option>
                                              <option value="psp">PSP</option>
                                              <option value="ssp">SSP</option>
                                          </select><input type="hidden" name="hiddealertype" id="hiddealertype" > </td>
                                  </tr>
                                  <tr>
                                      <td align="left" bgcolor="#edf4ff">Select MSP/PSP/SSP Dealer:</td>
                                      <td align="left" bgcolor="#edf4ff"><select name="newdealertype" id="newdealertype" class="swiftselect-mandatory" disabled>
                                              <option value="">Select Dealer Type First</option>
...
<!--                              <tr>-->
<!--                                <td width="40%" align="left" valign="top" bgcolor="#F7FAFF">Select Main Dealer : </td>-->
...
<!---->
<!--                              <tr>-->
<!--                                <td align="left" valign="top" bgcolor="#edf4ff">Main Dealer:</a></td>-->
<!--                                <td align="left" valign="top" bgcolor="#edf4ff"><input type="checkbox" name="maindealers" id="maindealers" /></td>-->
<!--                              </tr>-->
...
<!-- .Ends --->                              
                          ...
                          <td width="49%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                              ...
                              <tr bgcolor="#f7faff" >
                                ...
                                <td align="left" valign="top" bgcolor="#F7FAFF"><input type="checkbox" name="telecaller" id="telecaller" onchange="hidematrixbilling();" /></td>
                              </tr>
  ...
  <tr>
    <td colspan="2"><strong>Tax Info:</strong></td>
                               ...
                               <tr bgcolor="#F7FAFF">
                                ...
                                <td width="50%" align="left" valign="top" bgcolor="#F7FAFF"><input name="taxname" type="text" class="swifttext-mandatory" id="taxname" size="30" maxlength="30" autocomplete="off"  value="GST" /></td>
                              </tr>
                              <tr bgcolor="#F7FAFF">
                                <td align="left" valign="top" bgcolor="#F7FAFF">Tax Rate [%]:</td>
                                <td align="left" valign="top" bgcolor="#F7FAFF"><input name="taxamount" type="text" class="swifttext-mandatory" id="taxamount" size="30" maxlength="5" autocomplete="off" value="18" /></td>
                              </tr>
</table>
</td></tr>
                              <tr bgcolor="#f7faff">
                              ...
                              <tr bgcolor="#f7faff">
                                ...
                                <tr bgcolor="#f7faff">
                                <td align="left" valign="top" bgcolor="#EDF4FF">Dealer GSTIN:</td>
                                <td align="left" valign="top" bgcolor="#EDF4FF">
                                <input name="gst_no" type="text" class="swiftselect" id="gst_no" size="30"  autocomplete="off"  /><span id="state_gst" style="visibility:hidden"></span></td>
                              </tr>
                              <tr bgcolor="#f7faff">
                                <td align="left" valign="top" bgcolor="#EDF4FF">Dealer PAN NO:</td>
                                <td align="left" valign="top" bgcolor="#EDF4FF"><input name="panno" type="text" class="swiftselect" id="panno" size="30"  autocomplete="off"  /></td>
                              </tr>
                             <tr><td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="2" style=" border:1px solid #ADD8F1" >
  <tr>
 ...
 <tr bgcolor="#f7faff">
  ...
  <tr>
    <td width="36%" height="19" align="left" valign="top" bgcolor="#edf4ff" >Last Password: </td>
                              ...
                              <tr bgcolor="#f7faff" id="matrixbilling">
                                <td align="left" valign="top" bgcolor="#f7faff">Enable Matrix<br> Billing:</td>
                                <td align="left" valign="top" bgcolor="#f7faff" ><input type="checkbox" name="enablematrixbilling" id="enablematrixbilling" /></td>
                              </tr>
                              <tr bgcolor="#f7faff">
                                <td align="left" valign="top" bgcolor="#f7faff">Edit Customer Data:</td>
                                <td align="left" valign="top" bgcolor="#f7faff" ><input type="checkbox" name="editcustdata" id="editcustdata" /></td>
                              </tr>
                              <tr bgcolor="#f7faff">
                                <td align="left" valign="top" bgcolor="#f7faff">Force Surrender:</td>
                                <td align="left" valign="top" bgcolor="#f7faff" ><input type="checkbox" name="forcesurrender" id="forcesurrender" /></td>
                              </tr>
                               <tr bgcolor="#f7faff">
                        ...
                        <tr>
                          <td colspan="2" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="98%" border="0" cellspacing="0" cellpadding="0" height="70">
                              ...
                              <tr>
                                <td width="26%" height="35" align="left" valign="middle">&nbsp;</td>
                                <td width="57%" height="35" align="right" valign="middle">

                                    <input type="button" onclick="copyaddressdealer()" name="copyadd" value="Copy Address" class= "swiftchoicebuttondisabled focus_redclass" id="copyadd">

                                    <input name="new" type="button" class= "swiftchoicebutton" id="new" value="New" onclick="newentry(); makefocus('businessname'); document.getElementById('form-error').innerHTML = '';cleargrid();" />
                                  &nbsp;
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="360" align="center" id="tabgroupgridh1" onclick="gridtab4('1','tabgroupgrid','&nbsp;&nbsp; PIN Numbers Not Registered'); " style="cursor:pointer" class="grid-active-tabclassr6">PIN Numbers Not Regd</td>
<!--                      <td width="4"></td>-->
                      <td width="360" align="center" id="tabgroupgridh2" onclick="gridtab4('2','tabgroupgrid','&nbsp;&nbsp; PIN Numbers Registered');" style="cursor:pointer" class="grid-tabclassr6">PIN Numbers Regd</td>
<!--                      <td width="4"></td>-->
                      <td width="360" align="center" id="tabgroupgridh3" onclick="gridtab4('3','tabgroupgrid','&nbsp;&nbsp; Product Mapping');" style="cursor:pointer" class="grid-tabclassr6">Product Mapping</td>
<!--                      <td width="4"></td>-->
...
<!--                      <td width="200" align="center" ></td>-->
  ...
  <tr>
    <td><div id="getmorecardlink" align="left"></div></td>
                       ...
                       <div id="tabgroupgridc3" style="overflow:auto; width:704px; padding:2px; display:none;" align="center">
                           <form action="" method="post" name="productsubmitform" id="productsubmitform" onSubmit="return false;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    <tr>
                                          ...
                                          <tr>
                                            <td width="39%" rowspan="15" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                  ...
                                                  <select name="productlist" size="5" class="swiftselect" id="productlist" style="width:250px; height:200px;" >
                                                    </select></td>
                                                </tr>
                                              </table></td>
                                            <td width="22%" >&nbsp;</td>
                                            <td width="39%" rowspan="15" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                  <td id="assignedlist" ><select name="selectedproducts" size="5" class="swiftselect" id="selectedproducts" style="width:250px; height:200px" >
                                                    </select></td>
                                                </tr>
                                              </table></td>
                                          </tr>
                        ...
                        <div id="tabgroupgridc4" style="overflow:auto; height:150px; width:704px; padding:2px; display:none;" align="center">
    ...
    <td><div id="tabgroupgridc1linksearch" style="height:20px; width:704px; padding:2px;">
                    ...
                    {?>
                          <div id="tabgroupgridc5" style="overflow:auto; width:704px; padding:2px; display:none;" align="center">
                              <form action="" method="post" name="dealersubmitform" id="dealersubmitform" onSubmit="return false;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                      <tr>
                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="4" >
                                                  <tr>
                                                      <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                  <td valign="top" class="swiftselectfont" style="padding-left:9px;" >PSP Dealers Under <span id="pspdea"></span></td>
                                                              </tr>
                                                              <tr>
                                                                  <td valign="top" >
                                                                      <div id="pspdealers" style="height:101px; overflow:scroll">
<!--                                                                      <select name="pspdealerslist" size="5" class="swiftselect" id="pspdealerslist" style="width:250px; height:200px;" multiple>-->
<!--                                                                      </select>-->
                                                                      </div></td>
                                                              </tr>
                                                          </table></td>
                                                      ...
                                                      <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                  <td style="padding-left:25px;"  class="swiftselectfont" ><span class="swiftselectfont" style="padding-left:9px"> MSP Dealer List</span> </td>
                                                              </tr>
                                                              <tr>
                                                                  <td ><div id="mspdealers" >
<!--                                                                      <select name="mspdealerslist"  class="swiftselect" id="mspdealerslist" >-->
<!--                                                                          <option value="">Select MSp dealer</option>-->
<!--                                                                      </select>-->
                                                                      </div> </td>
                                                              </tr>
                                                          </table></td>
                                      ...
                                      <tr>
                                          <td colspan="2" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                      <td width="61%" align="left" valign="middle" height="35"><div id="dealer-form-error"></div></td>
                                                      <td width="39%" align="right" valign="middle"><input name="deaupdateproduct" type="button" class= "swiftchoicebutton" id="deaupdateproduct" value="Update" onClick="deaformsubmit_update()" />
                                                          &nbsp;
                                                          <input name="clear" type="button" class="swiftchoicebutton" id="clear" value="Reset" onClick="dearesetfunc();" />
                                                          &nbsp;</td>
                                                  </tr>
                                              </table></td>
                                      </tr>
