                ...
                <td><form id="filterform" name="filterform" method="post" action="" onSubmit="return false;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        ...
                        <td width="29%" style="padding:0"><div align="right"><a onclick="gettotaldealerrcount();" style="cursor:pointer; padding-right:10px;"><img src="../images/imax-customer-refresh.jpg" alt="Refresh customer" title="Refresh customer Data" /></a></div></td>
                      </tr>
                      <tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    <tr>
                                      <td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                          <tr bgcolor="#f7faff">
                                            <td width="19%" align="left" valign="top">Dealer Name: <input type="hidden" name="dealerreceiptno" id="dealerreceiptno" />
                            <input type="hidden" name="dealerslno" id="dealerslno"/></td>
                                    ...
                                    <tr>
                                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" height="71" border="0" cellpadding="3" cellspacing="0">
                                          ...
                                          <tr bgcolor="#f7faff">
                                            ...
                                            <td align="left" valign="top"  bgcolor="#f7faff"><label for="label"> 
                                          ...
                                          <tr>
                                            <td width="100%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="#FFF2F2" style="border:1px solid #FFDFDF">
                                                ...
                                                <tr>
                                                  ...
                                                  <td ><div id="viewtheinvoice" style="display:none">
                                                  <a onclick="viewdealerinvoice();" id="viewinvoice" class="resendtext" style = "cursor:pointer"> View Invoice</a></div></td>
                                                </tr>
                                              </table></td>
                                          </tr>
                                          <tr>
                                    ...
                                    <tr>
                                      <td colspan="2" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td colspan="2" align="left" valign="middle" height="35"><div id="form-error"></div>
                                              <div id="productselectionprocess"></div></td>
                                          </tr>
                                          <tr>
                                            <td width="55%"><div id="displayreceiptdiv" align="left" style="display:none">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td><div align="right">
                                                        <input name="receiptcancellation" type="button" class="swiftchoicebuttonbignew" id="receiptcancellation" value="Receipt Cancellation" onClick="validatereceipt()" />
                                                      </div></td>
                                                  </tr>
                                                </table>
                                              </div></td>
