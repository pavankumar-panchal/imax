...
<script language="javascript" src="../functions/dealerattachcard.js?dummy=<?php echo (rand());?>"></script>
<script language="javascript" src="../functions/dealer-cardattach.js?dummy=<?php echo (rand());?>"></script>
