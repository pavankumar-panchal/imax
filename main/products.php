                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            ...
                            <td width="40%"><div align="right">Search By Product Code:</div></td>
                            <td width="33%" align="left"><div align="right">
                              <input name="searchproductcode" type="text" class="swifttext" id="searchproductcode" size="25" onkeyup="searchbyproductcodeevent(event);"  autocomplete="off"/>
                              <img src="../images/search.gif" width="16" height="15" align="absmiddle"  onclick="productdetailstoform(document.getElementById('searchproductcode').value);" style="cursor:pointer" /> </div></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                          ...
                                          <tr bgcolor="#edf4ff">
                                            ...
                                            <td align="left" valign="top" bgcolor="#F7FAFF"><input type="checkbox" name="productnotinuse" id="productnotinuse" /></td>
                                          </tr>
                                          <tr bgcolor="#f7faff">
                                            <td align="left" valign="top" bgcolor="#EDF4FF">Product Type:</td>
                                            <td align="left" valign="top" bgcolor="#EDF4FF"><select name="producttype" class="swiftselect" id="producttype" style="width:110px">
                                          ...
                                          <tr bgcolor="#edf4ff">
                                            ...
                                            <td align="left" valign="top" bgcolor="#F7FAFF" ><select name="productgroup" class="swiftselect-mandatory" id="productgroup" style="width:110px">
                                          ...
                                          <tr bgcolor="#edf4ff">
                                            ...
                                            <td align="left" valign="top" bgcolor="#F7FAFF" ><select name="updationtype" class="swiftselect-mandatory" id="updationtype">
                                          ...
                                          <tr bgcolor="#edf4ff">
                                            <td align="left" valign="top" bgcolor="#edf4ff">Allow for Dealer Purchase:</td>
                                            <td align="left" valign="top" bgcolor="#edf4ff"><input type="checkbox" name="allowdealerpurchase" id="allowdealerpurchase" onclick="dealerpurchasecaptionmandatory();" onchange="dealerpurchasecaptionmandatory();" /></td>
                                          </tr>
                                          <tr bgcolor="#edf4ff">
                                            <td align="left" valign="top" bgcolor="#F7FAFF">Dealer Purchase Caption:</td>
                                            <td align="left" valign="top" bgcolor="#F7FAFF"><input name="dealerpurchasecaption" type="text" class="swifttext" id="dealerpurchasecaption" size="40" maxlength="100"  autocomplete="off" /></td>
                                          </tr>
                                    ...
                                    <tr>
                                      <td colspan="2" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                         <tr>
                                            <td width="58%" height="35" align="left" valign="middle"><div id="form-error"></div></td>
                                            <td width="42%" height="35" align="right" valign="middle"><input name="new" type="button" class= "swiftchoicebutton" id="new" value="New" onclick="newentry(); document.getElementById('form-error').innerHTML = '';" />
                                              &nbsp;
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                      ...
                                      <tr>
                                        <td valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                            ...
                                            <tr bgcolor="#f7faff">
                                              <td colspan="2" align="left" valign="top" style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                  <tr>
                                                    <td width="14%" valign="top">In:
                                                      </td>
                                                    <td width="86%"><label>
                                                      <input type="radio" name="databasefield" id="databasefield0" value="productcode"/>
                                                      Product code</label>
                                                      <label>
                                                      <input type="radio" name="databasefield" id="databasefield1" value="productname" checked="checked"/>
                                                      Product Name</label>
                                                      <label>
                                                      <input type="radio" name="databasefield" id="databasefield2" value="productnotinuse"/>
                                                      Product Not in use</label>
                                                      <label>
                                                      <input type="radio" name="databasefield" value="producttype" id="databasefield3" />
                                                      Product Type</label>
                                                      <label>
                                                      <input type="radio" name="databasefield" value="productgroup" id="databasefield4" />
                                                      Product Group</label>
                                            ...
                                            <tr bgcolor="#edf4ff">
                                              ...
                                              <td align="left" valign="top"><select name="orderby" id="orderby" class="swiftselect">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="140px" align="center" id="tabgroupgridh1" onclick="gridtab2('1','tabgroupgrid','&nbsp; &nbsp;Default'); " style="cursor:pointer" class="grid-active-tabclass">Default</td>
                                  <td width="2">&nbsp;</td>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                                ...
                                <tr>
                                  <td colspan="3" align="center" valign="top"><div id="tabgroupgridc1" style="overflow:auto; height:150px; width:704px; padding:2px;" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
</table><div id="productresultgrid" style="overflow:auto; display:none; height:150px; width:704px; padding:2px;" align="center">&nbsp;</div></div>
