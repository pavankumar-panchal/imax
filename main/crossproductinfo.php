  ...
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="contactcontentdisplay" style="border:1px solid #379BFF"  bgcolor="#F0F5F7">
      <tr style="height:35px;" bgcolor="#CBE0FA" >
        <td width="18%" style="padding-left:8px;" ><strong>Company Name:</strong></td>
        <td width="77%" id="displaycompanyname" style="padding-left:8px;">&nbsp;</td>
        <td width="5%" align="right" style="padding-right:10px;"><div align="right"><img src="../images/plus.jpg" border="0" id="toggleimg2" name="toggleimg2"  align="absmiddle" onClick="displaydivdisplay('filterdiv','toggleimg2');" style="cursor:pointer"/></div></td>
      </tr>
      <tr>
  ...
  <tr>
    <td valign="top"> <div id="yearwisedisplay" > <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        ...
        <td align="right" class="header-line" style="padding-right:10px"><div align="right"><img src="../images/plus.jpg" border="0" id="toggleimg1" name="toggleimg1"  align="absmiddle" onClick="displaydivdisplay('displaydetails','toggleimg1');" style="cursor:pointer"/></div></td>
      </tr>
      <tr>
        <td colspan="2" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <tr><td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="3"  class="year-grid-border">
                    <tr bgcolor="#e9967a">
                      <td class="year-grid-td-border"><div align="center"><strong>Groups</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2004-05</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2005-06</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2006-07</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2007-08</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2008-09</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2009-10</strong></div></td>
                      <td class="year-grid-td-border"><div align="center"><strong>2010-11</strong></div></td>
                    </tr>
                    <tr >
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>SPP</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                    ...
                    <tr >
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>STO</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                    ...
                    <tr>
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>TDS</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                    ...
                    <tr>
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>SVH</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                    ...
                    <tr>
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>SVI</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                    ...
                    <tr>
                      <td bgcolor="#e9967a" class="year-grid-td-border"><div align="center"><strong>SAI</strong></div></td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
                      <td class="year-grid-td-border">&nbsp;</td>
              ...
              <td colspan="2"  style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="50%" align="right" valign="middle"><input name="new" type="button" class= "swiftchoicebutton" id="new" value="New" onclick="newentry();document.getElementById('form-error').innerHTML = ''; " />
                      ...
                      &nbsp;
                      <input name="delete" type="submit" class="swiftchoicebutton" id="delete" value="Delete"  onclick="formsubmit('delete');"/>                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td><div id="customerlink" align="center"></div>
                                    <div id="tabgroupgridc1link" ></div></td>
                              </tr>
                            </table>
                        </div>
