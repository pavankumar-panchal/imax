<?php
if($p_dealerbulkprintinvoice <> 'yes') 
{ 
...
<script language="javascript" src="../functions/dealerbulkprinting.js?dummy=<?php echo (rand());?>"></script>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr>
                            <td width="27%" class="active-leftnav">Report - Dealer Bulk Print (Invoices)</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
											...
											?>
                                                                          ...
                                                                          <tr>
                                                                            ...
                                                                            <td align="left" valign="top"   height="10" ><select style="width: 180px;" id="usagetype" class="swiftselect" name="usagetype">
                                                                                ...
                                                                                <option value="mutliuser">MULTI USER</option>
