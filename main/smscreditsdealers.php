                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    ...
                                    <tr>
                                      <td width="52%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" height="71" border="0" cellpadding="3" cellspacing="0">
                                        <tr bgcolor="#f7faff">
                                          <td>Invoice No:</td>
                                          <td><input name="invoiceno" type="text" class="swifttext" id="invoiceno" size="30" maxlength="12" autocomplete="off" style="background:#FFFFCC" readonly="readonly" value="New"/><input name="lastslno" id="lastslno" type="hidden" /></td>
                                        </tr>
                                        <tr bgcolor="#f7faff">
                                          <td align="left" valign="top">SMS Account:</td>
                                          <td align="left" valign="top" bgcolor="#f7faff" ><div id="smsaccountlist">
                                        ...
                                        <tr bgcolor="#f7faff">
                                          ...
                                          <td width="64%" align="left" valign="top" bgcolor="#f7faff" height="25px;"><div id="displayquantity">
                                            <input name="quantity" type="text" class="swifttext-mandatory" id="quantity" size="30" maxlength="6" autocomplete="off"  onkeyup="gettotalamount();"/>
                                          </div></td>
                                        </tr>
                                        <tr bgcolor="#f7faff">
                                        ...
                                        <tr bgcolor="#f7faff">
                                          <td colspan="2" align="left" valign="top" bgcolor="#f7faff"><label>
                                            ...
                                            <input type="checkbox" name="sendinvoice" id="sendinvoice"  />
                                             Send Invoice copy to Dealer on Creation</label></td>
                                        </tr>
                                      </table></td>
                                      <td width="48%" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                                        ...
                                        <tr bgcolor="#f7faff">
                                          ...
                                          <td align="left" valign="top" bgcolor="#EDF4FF"  id="creditsavailableforaccount"  >Not Available</td>
                                        </tr>
                                        <tr bgcolor="#f7faff">
