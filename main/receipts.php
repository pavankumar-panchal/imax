                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    <tr>
                                      <td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                          <tr bgcolor="#f7faff">
                                            <td width="19%" align="left" valign="top">Customer Name: <input type="hidden" name="receiptno" id="receiptno" />
                                          ...
                                          <tr bgcolor="#f7faff">
                                            ...
                                            <td align="left" valign="top"  bgcolor="#f7faff"><label for="label"> </label>
                                              ...
                                              <label for="cash"><br />
                                                ...
                                                <br />
                                              <label for="cash">
                                                <input type="radio" name="paymentmode" id="upi" value="upi"  onclick="hideorshowremarksdiv();"/>
                                                UPI<br />
                                              </label></td>
                                          </tr>
                                          <tr bgcolor="#f7faff">
