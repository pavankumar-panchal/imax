                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="3" style="border:1px solid #333333;">
                                                      <tbody id="showdealeritems"> <tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td align="left" valign="top"><input name="paymentamount" type="text" class=" swifttext-mandatory" id="paymentamount" size="32" placeholder="Enter total received amount from dealer" maxlength="12"  autocomplete="off"/>
                                                          </tr>
                                                          <tr>
                                                        ...
                                                        <tr>
                                                          <td align="left" width="18%">Item Amount:</td>
                                                          <td align="left" valign="top"><input name="itemamount" type="text" class=" swifttext-mandatory" id="itemamount" 
                                                            size="30" maxlength="12"  autocomplete="off"/ disabled>
                                                          </tr>
                                                        <tr>
                                                      </tbody>
                                                        <tr>
