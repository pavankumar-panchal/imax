                                    ...
                                    <tr>
                                      ...
                                      <tr bgcolor="#f7faff">
                                          ...
                                          <tr bgcolor="#f7faff">
                                            ...
                                            <td align="left" valign="top" bgcolor="#EDF4FF" id="displayentereddate"><? $fetch = runmysqlqueryfetch("SELECT fullname FROM inv_mas_users WHERE slno = '".imaxgetcookie('userid')."'"); echo($fetch['fullname']); ?>
                                            </td>
                                          </tr>
                                      <tr bgcolor="#f7faff">
