                ...
                <td colspan="2"><form id="filterform" name="filterform" method="post" action="" onsubmit="return false;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr>
                        ...
                        <!-- <td colspan="2" align="left"><input name="detailsearchtext" type="text" class="swifttext" id="detailsearchtext"   onchange="searchcustomer()"  autocomplete="off"  style="width:204px"/> -->
                                          ...
                                          <tr>
                                                ...
                                                <tr>
                                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                      <tr>
                                                        ...
                                                        <td width="18%" onclick="tabopen5_new('1','tabg1')" class="producttabheadactive" id="tabg1h1" style="cursor:pointer;"><div align="center"><strong>General Details</strong></div></td>
                                                        <td width="2%" class="producttabheadnone"></td>
                                                        <td width="18%" onclick="tabopen5_new('2','tabg1')" class="producttabhead" id="tabg1h2" style="cursor:pointer;"><div align="center"><strong>Contact Details</strong></div></td>
                                                        <td width="2%" class="producttabheadnone"></td>
                                                        <td width="18%" onclick="tabopen5_new('3','tabg1')" class="producttabhead" id="tabg1h3" style="cursor:pointer;"><div align="center"><strong>GSTIN Details</strong></div></td>
                                                        <td width="2%" class="producttabheadnone">&nbsp;</td>
                                                              ...
                                                              <tr>
                                                                <td width="51%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td width="65%" bgcolor="#edf4ff"><select name="state" class="swiftselect-mandatory type_enter focus_redclass" id="state" onchange="getdistrict('districtcodedisplay',this.value);getgstcode(this.value);" onkeyup="getdistrict('districtcodedisplay',this.value);getgstcode(this.value);"  style="width:200px;">
											...
											?>
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td  bgcolor="#F7FAFF"><select name="type" class="swiftselect type_enter focus_redclass" id="type" style="width:200px;" required>
 ...
 <?php 
	...
	?>
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td bgcolor="#edf4ff"><select name="category" class="swiftselect type_enter focus_redclass" id="category" style="width:200px" required>
											...
											?>
                                                                ...
                                                                <td width="49%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                    <tr>
                                                                      ...
                                                                      <td width="61%" bgcolor="#edf4ff"><textarea name="remarks" cols="25" class="swifttextarea type_enter focus_redclass" id="remarks" style="width:169px;resize:auto"></textarea></td>
                                                                    </tr>
                                                                        <tr>
                                                                            <td bgcolor="#F7FAFF">&nbsp;TAN NO:</td>
                                                                            <td bgcolor="#F7FAFF"><input name="tanno" type="text" class="swifttext" id="tanno" style="background:#FEFFE6; width:169px" size="30" maxlength="40"  autocomplete="off"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td bgcolor="#F7FAFF">&nbsp;PAN NO:</td>
                                                                            <td bgcolor="#F7FAFF"><input name="panno" type="text" class="swifttext" id="panno" style="background:#FEFFE6; width:169px" size="30" maxlength="40"  autocomplete="off"/></td>
                                                                        </tr>
                                                                    <tr>
                                                                      ...
                                                                      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                                                <tr bgcolor="#edf4ff">
                                                                                  <td width="39%" height="15px" align="left" valign="top" bgcolor="#edf4ff">&nbsp;Password:</td>
                                                                                ...
                                                                                <tr bgcolor="#F7FAFF">
                                                                                  <td colspan="2" height="15px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                      <tr>
                                                                    ...
                                                                    <!--<tr height="20px">
                                                                      ...
                                                                      <input name="gst_no" type="text" id="gst_no" style="float: left;" class="swiftselect type_enter focus_redclass" size="23" placeholder="Please Enter GSTIN number"/>
                                                                      </td>
                                                                    </tr>-->
                                                                    <tr height="20px">
                                                                      ...
                                                                      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr>
                                                                            <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                                                <tr>
                                                                                  <td width="78%" bgcolor="#edf4ff" align="left">Disable Login:</td>
                                                                                  <td width="22%" bgcolor="#edf4ff"><input type="checkbox" name="disablelogin" id="disablelogin" class="type_enter focus_redclass" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#F7FAFF">Corporate Order:</td>
                                                                                  <td bgcolor="#F7FAFF"><input type="checkbox" name="corporateorder" id="corporateorder" class="type_enter focus_redclass"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#edf4ff">Company Closed:</td>
                                                                                  <td bgcolor="#edf4ff"><input type="checkbox" name="companyclosed" id="companyclosed" class="type_enter focus_redclass"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#F7FAFF">Is Dealer/Relyon:</td>
                                                                                  <td bgcolor="#F7FAFF"><input type="checkbox" name="isdealer" id="isdealer" class="type_enter focus_redclass"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#edf4ff">Display in Website:</td>
                                                                                  <td  bgcolor="#edf4ff"><input type="checkbox" name="displayinwebsite" id="displayinwebsite" class="type_enter focus_redclass"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#F7FAFF">Promotional SMS:</td>
                                                                                  <td  bgcolor="#F7FAFF"><input type="checkbox" name="promotionalsms" id="promotionalsms" class="type_enter focus_redclass" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td bgcolor="#edf4ff">Promotional Email:</td>
                                                                                  <td  bgcolor="#edf4ff"><input type="checkbox" name="promotionalemail" id="promotionalemail" class="type_enter focus_redclass generallastfield"/></td>
                                                                                </tr>
                                                                              </table></td>
                                                    ...
                                                    <!-- Added for Additional GSTIN Entries on Aug 2018 -->
                                                    <div style="display:none;" align="justify" id="tabg1c3">
                                                        <div style="height:300px;"> 
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="3" id="gstentry" class="gsttable">
                                                                  <tr>
                                                                    <th scope="row" width="15%" class="td-border-grid" bgcolor="#F7FAFF">GSTIN No : <span id="state_gst" style="visibility:hidden"></span></th>
                                                                    <td class="td-border-grid" bgcolor="#F7FAFF"><input type="text" name="gst_no" id="gst_no" class="swifttext-mandatory type_enter focus_redclass" placeholder="Please Enter GST Number"></td>
                                                                  </tr>
                                                                  <tr>
                                                                    <th class="td-border-grid" bgcolor="#edf4ff" scope="row" width="15%">Effective From : </th>
                                                                    <td class="td-border-grid" bgcolor="#edf4ff"><input type="date" name="effective_from" id="effective_from" class="swifttext-mandatory type_enter focus_redclass"></td>
                                                                  </tr>
                                                                  <tr>
                                                                    <th colspan="2" scope="row"><span id="gst_delete_res"></span></th>
                                                                  </tr>
                                                                <!--<tr>
                                                                    <th colspan="2" scope="row"><input type="hidden" name="gst_hidden" id="gst_hidden" class="swifttext-mandatory type_enter focus_redclass"></th>
                                                                  </tr>-->
                                                                </table>
                                                                
                                                                <table width="100%" border="" cellspacing="5" cellpadding="5" id="gstdetails" class="gsttable">
                                                                      <tr>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="8%">Sl No</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="15%">GSTIN</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="15%">Entered By</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="15%">Effective From</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="15%">Created At</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col" width="15%">Updated At</th>
                                                                        <th class="td-border-grid" bgcolor="#F7FAFF" scope="col">Options</th>
                                                                      </tr>
                                                                </table>
                                                        </div>        
                                                    </div>
                                          ...
                                          <tr>
                                            <td style="padding-top:5px"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="70">
                                                <tr>
                                                  ...
                                                  <tr>
                                                        <td align="right" bgcolor="#F7FAFF" class="company_font" colspan="2">Old Business Name [Company]:
                                                       <input name="oldbusinessname" type="text" class="swifttext-mandatory  type_enter focus_redclass reverser_class"  id="oldbusinessname" size="40" maxlength="100"  autocomplete="off" placeholder="Enter this field only if required" /></td>
                                                      </tr>
                                                      </table>
                                                  </div><div id="form-error"></div></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <?php } ?>
                                                  <td width="17%" align="right" valign="middle" id="info_copy_button" ><input type="button" onclick="copyaddress()" name="copyadd" value="Copy Address" class= "swiftchoicebuttondisabled focus_redclass" id="copyadd"> </td>
                          ...
                          <div align="left" style="display:block;background-color: #FFDFDF; height:20px; padding-top:5px;" id="detailsdiv"  >
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="23%"><div onclick="displayinvoicedetails('pinvoice')" class="resendtext"><strong style="padding-left:3px;">View Invoice Details </strong></div></td>
                                <td width="27%"><div onclick="displayinvoicedetails('minvoice')" class="resendtext"><strong style="padding-left:3px;">View Matrix Invoice Details </strong></div></td>
                                <td width="15%"><div onclick="displaycustomeralertdetails();newcustomeralert();" class="resendtext"><strong style="padding-left:3px;">Customer Alerts </strong></div></td>
                              </tr>
                            </table>
                          </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><div id="invoicedetailsgrid" style='background:#fff;width:709px'>
                                    ...
                                    <div align="right" style="padding-top:15px; padding-right:25px">
                                      <input type="button" value="Close" id="closecolorboxbutton2"  onclick="$().colorbox.close();" class="swiftchoicebutton"/>
                                    </div>
                                  </div></td>
                              </tr>
                            </table>
...
<div style="display:none">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                  <td><div id="pindetails" style="display:none;">
                                                    <table width="89%" align="center" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                          ...
                          <!-- Short Key For Page Redirect by Bhavesh -->
                          <div style="display:none">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                  ...
                  <td class="we Dn">Focus on Customer Id search text</td>
                                    ...
                                    <div align="right" style="padding-top:15px; padding-right:25px">
                                      <input type="button" value="Close" id="closecolorboxbutton3"  onclick="$().colorbox.close();" class="swiftchoicebutton"/>
                                    </div>
                                  </div></td>
                              </tr>
                            </table>
                          </div>
                          <!-- End Short Key For Page Redirect by Bhavesh -->
                        </form></td>
                    </tr>
                    <tr>
                            ...
                            <tr>
                              <td><div id="customeralertsgrid" style='background:#fff;width:709px'>
                                  <form id="customeralertform" name="customeralertform" method="post" action="" onsubmit="return false">
                                    ...
                                    <div align="right" style="padding-top:15px; padding-right:25px">
                                      <input type="button" value="Close" id="closecolorboxbutton4"  onclick="$().colorbox.close();" class="swiftchoicebutton"/>
                                    </div>
                                  </form>
                                </div></td>
                            </tr>
...
<td width="140" id="tabgroupgridh6" style="cursor:not-allowed" class="grid-tabclass">Manual Registration</td>
								  ...
								  if($p_forcesurrender == 'yes')
								  {
								  ?>
                                  <td width="140" id="tabgroupgridh9" onclick="gridtabcus5('9','tabgroupgrid','&nbsp; &nbsp;Force Surrender'); displayelement('tabgroupgridc9','transferscratchcarddiv');clearcarddetails();" style="cursor:pointer" class="grid-tabclass">Force Surrender</td>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                                ...
                                <tr>
                                  <td colspan="4" align="center" valign="top"><div id="tabgroupgridc5" style="overflow:auto; height:150px; width:704px; padding:2px; display:none;"" align="center">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                                ...
                                                <tr bgcolor="#edf4ff">
                                                  <td colspan="2" align="left" valign="top" style="padding:0px;"><div id="scratchdisplay" style="display:block;">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                          <td width="30%" valign="top" align="left">PIN  Number:</td>
                                                          <td width="62%" valign="top" align="left"><input name="pinno" type="hidden" id="pinno" />
                                                            <div id="dispreregcardlist">
                                                              <div align="left">
											...
											?>
                                                ...
                                                <tr bgcolor="#f7faff">
                                                  <td colspan="3" valign="top" bgcolor="#F7FAFF"><table width="98%" border="0" cellspacing="0" cellpadding="0" height="70">
                                                      ...
                                                      <tr>
                                                        <td width="43%" height="35" align="left" valign="middle">&nbsp;</td>
                                                        <td width="57%" height="35" align="right" valign="middle"><input name="checkpinno" type="button"  id="checkpinno" value="Check PIN" class="swiftchoicebutton" onclick=" checkpin();" />
                                                          &nbsp;&nbsp;
                                    ...
                                    <div id="tabgroupgridc9" style="overflow:auto; height:auto; width:704px; padding:2px; display:none;" align="center">
                                      <?php if($p_forcesurrender == 'yes') { ?>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
