                                                          ...
                                                          <td width="67%" valign="top" style="padding-left:3px"><table width="67%" border="0" cellspacing="0" cellpadding="6" style="border-left:solid 1px #cccccc; border-bottom:solid 1px #cccccc; border-top:solid 1px #cccccc ">
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td align="left" valign="top"   height="10" ><select name="currentdealer2" class="swiftselect" id="currentdealer2" style="width:180px;">
                                                                    <option value="">ALL</option>
                                                                    <?php include('../inc/firstdealer1.php');?>
                                                                  </select></td>
                                                              </tr>
                                                              <tr>
...
<!------------------- Commenting Products Addition In Page ------------------------------->

<!--
<div id="moreproducts" class="additional">
 <center><h1><u>Add Products</u></h1></center>
...
<table width="100%" border="0">
  ...
  <tr>
    <td>
	<select name="productnametypes[]" class="swiftselect" style="width:195px;">
        ...
        <td>
    <select name="usagetypes[]" class="swiftselect"  style="width:195px;">
     <option value="" selected="selected">Select a Item</option>
    ...
    <td>
    <input type="text" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" name="updationprice_new[]" class="swifttext" id="updationprice">
    </td>
    <td><input type="text" class="swifttext" name="briefdescription_new[]" id="briefdescription"></td>
  </tr>
...
<select name="productnametypes[]" class="swiftselect" style="width:195px;">
    ...
    <td><input type="text" class="swifttext" name="briefdescription_new[]" id="briefdescription_new"></td>
  </tr>
