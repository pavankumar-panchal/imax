          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><div id="filterdiv" style="display:none1;">
                                      ...
                                      <tr>
                                        <td valign="top" ><table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFD3A8" style="border:dashed 1px #545429">
											...
											?>
                                                              ...
                                                              <tr>
                                                                <td>District:</td>
                                                                <td align="left" valign="top"  id="districtcodedisplaysearch" height="10" ><select name="district" class="swiftselect" id="district" style="width:180px;">
                                                                    <option value="">ALL</option>
                                                                  </select></td>
                                                              </tr>
                                                              <tr>
              ...
              <td width="39%" valign="top" style="border-left:1px solid #CCCCCC;padding-left:6px"><table width="96%" border="0" cellspacing="0" cellpadding="2" >
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width="45%" align="left" valign="middle"  ><input name="filter" type="button" class="swiftchoicebutton-red" id="filter" value="Search" onclick="advancesearchimplementer();" />
                                                      &nbsp;
                                      ...
                                      <td width="100%" ><div   id="displaytext" style="display:block; ">
                                        ...
                                        <div id=displaydetails style="display:none">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                              <td><table width="100%" border="0" cellspacing="0" cellpadding="4" style="border:#CCCCCC 1px solid " bgcolor="#FFFFEC" >
                                                  <tr>
											...
											?>
                                                    ...
                                                    <td width="8%" valign="middle"><a  onclick="getdealerdetails('selectdealer');"  class="r-text">Go &gt;&gt;</a></td>
                                                    <td width="61%" valign="bottom" ><div id="dealerdivdisplay" style="display:none1">
                                                        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0"  >
                                                          <tr>
                                                            <td valign="top" ><strong>
                                                              <div style="padding-top:8px;"><span id="dealerdisplayheading"><font color="#426b8e">Dealer Name: </font></span><span id="displaydealername" ><font color="#FF0000">Not Selected</font></span>&nbsp;&nbsp;<span style="display:none" id="displaydealerdetailsicon"><img src="../images/help-image.gif" width="13" height="14"  onclick ="showdealerdetails();" title="Dealer Details"  align="absmiddle" style="cursor:pointer"/></span></div>
                                                              </strong></td>
                                                          </tr>
                                                          <tr>
                                                        ...
                                                        <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                              <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                  <tr >
                                                                    <td width="19%"  style="padding-left:5px">Implemantation Type:</td>
                                            ...
                                            <tr>
                                              <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="contactcontentdisplay" style="border:1px solid #D6D6D6"   >
                                                  <tr style="height:25px;"  bgcolor="#D6D6D6" >
                                                    ...
                                                    <td width="7%" bgcolor="#D6D6D6"  style="padding-left:8px; padding-top:5px;"><input type="hidden" id="finalinvoice" name="finalinvoice"/>
                                                      ...
                                                      &nbsp;</td>
                                                    <td width="65%" bgcolor="#D6D6D6"  style="padding:5px;" id="invoice_error">&nbsp;</td>
                                                              ...
                                                              <tr>
                                                                    ...
                                                                    <tr>
                                                                      <td colspan="2" ><div id="cfentrydiv" style="display:none">
                                                                            ...
                                                                            <tr bgcolor="#EDF4FF">
                                                                              <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                  <tr>
                                                                                    ...
                                                                                    <td width="27%" align="left" valign="top" bgcolor="#EDF4FF" ><div align="right"><a  onclick="advcollectedmail('advamount')"  class="r-text">Send Email &#8250;&#8250;</a></div></td>
                                                                                  </tr>
                                                                                </table></td>
                                                                            </tr>
                                                                          </table>
                                                                        ...
                                                                        <div id="invoiceentrydiv" style="display:none">
                                                                          <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                                            <tr bgcolor="#EDF4FF">
                                                                              <td width="21%" align="left" valign="top">Receipt :</td>
                                                                            ...
                                                                            <tr bgcolor="#EDF4FF">
                                                                              <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                  <tr>
                                                                                    ...
                                                                                    <td width="27%" align="left" valign="top" bgcolor="#EDF4FF" ><div align="right"><a  onclick="advcollectedmail('receipt')"  class="r-text">Send Email &#8250;&#8250;</a></div></td>
                                                                                  </tr>
                                                                                </table></td>
                                                                            </tr>
                                                                          </table>
                                                                ...
                                                                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                    <tr bgcolor="#EDF4FF">
                                                                      ...
                                                                      <td align="left" valign="top" bgcolor="#EDF4FF" ><textarea name="balancerecovery" cols="27" class="swifttextarea-mandatory" id="balancerecovery" maxlength="200" style="resize: none;"></textarea></td>
                                                                    </tr>
                                                                  </table></td>
                                                              </tr>
                                                            </table></td>
                                                              ...
                                                              <tr bgcolor="#f7faff">
                                                                <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                                    <tr bgcolor="#edf4ff">
                                                                      ...
                                                                      <td width="34%" valign="top" bgcolor="#edf4ff" style="border-right:1px solid  #C6E2FF"><input name="attachement_raf" type="text" class="swifttext" id="attachement_raf"  style="background:#FEFFE6;" size="30" maxlength="100" readonly="readonly"  autocomplete="off"/>
                                                                      ...
                                                                      <td width="14%"   align="left"  valign="top" bgcolor="#EDF4FF" >Remarks:</td>
                                                                      <td width="37%"   align="left"  valign="top" bgcolor="#EDF4FF" id="downloadlinkfile1" ><input name="requrimentremarks" class="swifttext-mandatory" id="requrimentremarks"  size="40" maxlength="100" autocomplete="off"/>
                                                                        <input type="hidden" name="impraflastslno" id="impraflastslno" />
                                                                        <input type="hidden" name="rafslno" id="rafslno" />
                                                                        <input type="hidden" name="deleterafslno" id="deleterafslno" />
                                                                        <input type="hidden" name="raflag" id="raflag" />
                                                        ...
                                                        <tr>
                                                          <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                              ...
                                                              <tr bgcolor="#EDF4FF">
                                                                ...
                                                                <td colspan="4" align="left" valign="top" bgcolor="#EDF4FF" ><input name="startdate" type="text" class="swifttext-mandatory" id="DPC_startdate" size="30" autocomplete="off" value="" readonly="readonly" /></td>
                                                              </tr>
                                                              <tr bgcolor="#EDF4FF">
                                                              ...
                                                              <tr bgcolor="#EDF4FF">
                                                                ...
                                                                <td colspan="3" align="left" valign="top" bgcolor="#f7faff" ><textarea name="sales_remarks" cols="67"  class="swifttextarea-mandatory" id="sales_remarks" style="resize: none;"></textarea></td>
                                                              </tr>
                                                            </table></td>
                                                        </tr>
                                                      </table></td>
                                                                            ...
                                                                            <td colspan="2" ><div id="displayattendance" >
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                                                  <tr bgcolor="#f7faff">
                                                                                    ...
                                                                                    <td colspan="3" align="left" valign="top" bgcolor="#f7faff" ><input name="attendance_vendor" type="text" disabled="disabled"   class="diabledatefield" id="attendance_vendor" style="width:520px" size="30" maxlength="200"  autocomplete="off">
                                                                                      </input></td>
                                                                                  </tr>
                                                                                  <tr bgcolor="#edf4ff">
                                                                            ...
                                                                            <td colspan="2" ><div id="displaycustomization" >
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                                                  <tr bgcolor="#f7faff">
                                                                                    ...
                                                                                    <td colspan="2" align="left" valign="top" bgcolor="#f7faff" ><input name="customization_remarks" type="text" class="diabledatefield" id="customization_remarks" style="width:520px" maxlength="500"  autocomplete="off"/>
                                                                                      </input></td>
                                                                                  </tr>
                                                                                  <tr bgcolor="#edf4ff">
                                                              ...
                                                              <tr>
                                                                <td colspan="2" ><div id="displaywebimplementation"  >
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                                      <tr bgcolor="#f7faff">
                                                                        <td width="112" align="left" valign="top" bgcolor="#f7faff">Remarks :</td>
                                                                        <td width="593" align="left" valign="top" bgcolor="#f7faff" ><input name="web_remarks" type="text" disabled="disabled"   class="diabledatefield" id="web_remarks" style="width:520px" size="30" maxlength="200" /></td>
                                                                      </tr>
                                                                    </table>
                                                                  </div></td>
                                                              </tr>
                                            ...
                                            <tr>
                                              <td ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="contactcontentdisplay" style="border:1px solid #D6D6D6" >
                                                  <tr style="height:25px;"  bgcolor="#D6D6D6" >
                                                    <td width="42%" style="padding-left:8px; padding-top:5px;" valign="top"><strong>10. Implementation Details</strong></td>
                                                    <td width="53%" bgcolor="#D6D6D6"  style="padding-left:8px; padding-top:5px;">&nbsp;</td>
                                                    <td width="5%" style="padding-right:10px;"><div align="right"></div></td>
                                                  </tr>
                                                  <tr>
                                            ...
                                            <tr>
                                              <td ><table width="100%" border="0" cellspacing="0" cellpadding="0" height="70">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width="50%" height="35" align="right" valign="middle"><input name="approvereject" type="button" class= "swiftchoicebuttonbig" id="approvereject" value="Approve / Reject" onclick="approvevalidate()" />
                                                      &nbsp;
                                                      &nbsp;
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="right"><input type="button" name="approve1" class="swiftchoicebutton" value="Approve" id="approve1" onclick="displayapproverejdiv('approvetype');"/>
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <input type="button" value="Close" id="closepreviewbutton0" name="closepreviewbutton0"  onclick="$().colorbox.close();" class="swiftchoicebutton"/></td>
                                                    </tr>
                                                  </table>
                                                </div>
