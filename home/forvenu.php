...
<body>
	<form action="" method="post">
		...
		<p>
			...
			<input type="Radio" name="filter1" id="duplicateTitle1" value="duplicateTitle1" <?php echo ($_POST['filter1'] == 'duplicateTitle1' ? 'checked' : '') ?>><span id="duplicateTitle1Text">Duplicate
				Title1</span>
			<input type="Radio" name="filter1" id="duplicateTitle2" value="duplicateTitle2" <?php echo ($_POST['filter1'] == 'duplicateTitle2' ? 'checked' : '') ?>><span id="duplicateTitle2Text">Duplicate
				Title2</span>
			<input type="Radio" name="filter1" id="doubleEntries" value="doubleEntries" <?php echo ($_POST['filter1'] == 'doubleEntries' ? 'checked' : '') ?>><span id="doubleEntriesText">Double
				Entries</span>
			<input type="checkbox" name="excludeSurrender" id="excludeSurrender" value="excludeSurrender" <?php echo ($_POST['excludeSurrender'] == 'excludeSurrender' ? 'checked' : '') ?>><span
				id="excludeSurrenderText">Exclude surrendered</span><br />
