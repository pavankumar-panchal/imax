...
#Added onJan 23 2018
$onlineinvoiceslno = $onlineinvoiceslno;
$onlineinvoiceslno1 = encodevalue($onlineinvoiceslno);
...
$array[] = "##INVOICESLNO##%^%".$onlineinvoiceslno1;
...
//not needed rslmail($fromname, $fromemail, $toarray, $subject, $text, $html,$ccarray,$bccarray,$filearray,$replyto);
