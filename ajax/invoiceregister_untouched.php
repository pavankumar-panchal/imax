...
left join dealer_online_purchase on dealer_online_purchase.onlineinvoiceno = inv_invoicenumbers.slno where  left(inv_invoicenumbers.createddate,10) = '".date('Y-m-d')."' order by inv_invoicenumbers.slno";
...
from inv_invoicenumbers left join dealer_online_purchase on dealer_online_purchase.onlineinvoiceno = inv_invoicenumbers.slno where     left(inv_invoicenumbers.createddate,10) = '".date('Y-m-d')."'  group by inv_invoicenumbers.slno with rollup  limit ".($fetchresultcount).",1 ";
